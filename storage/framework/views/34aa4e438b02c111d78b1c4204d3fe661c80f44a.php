        ...
        <div class="layout-page">
          ...
          <div class="my-4 d-flex justify-content-center align-item-center px-auto">
            <div class="ms-4 container card text-start justify-content-start w-25">
                <h4 class="text-primary mt-3">Cdc</h4>
            </div>
          </div>
          <!-- Content wrapper -->
          <div class="content-wrapper">
                ...
                <div class="content-wrap container mt-4">
                 ...
                 <?php
                    $segment = request()->input('search_zone_cdc');
                            //echo $segment; // article
                    $campa = request()->input('search_campagne_cdc');                          
                  ?>
              ...
              <div class="col-lg-3 mt-2 order-0">
                <div class="card shadow-none bg-transparent border border-primary mb-3">
                    <div class="card-body">
                        ...
                        <span class=" ">Valeur Total Cdc</span>
                ...
                <?php 
                            $owner_nameSection = Auth::user()->section;
                                   ...
                                   $total_int_scoop_24_25s = DB::table('intrant_equipements')
                                    ...
                                    ->where('choix_formulaire_remplir', 'cdc')
                                    ->where('nom_section', $owner_nameSection)
                                    ->sum('superficie_prevu_groupement');
                  ...
                  <br>
                    ...
                    <table class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody class="table-border-bottom-0"  id="clcTableBody">
                        <?php $__currentLoopData = $cdc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cdcs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              
                              <td><?php echo e($cdcs->nom_zone); ?></td>
                              <td><?php echo e($cdcs->nom_section); ?></td>
                              <td><?php echo e($cdcs->campagne_coton); ?></td>
                              <td><?php echo e($cdcs->code_scoop_producteur); ?></td>
                              <td><?php echo e($cdcs->nom_scoop); ?></td>
                              <td><?php echo e($cdcs->nbre_appareil_atomiseur_piece); ?></td>
                              <td><?php echo e($cdcs->nbre_appareil_dos_piece); ?></td>
                              <td><?php echo e($cdcs->nbre_appareil_pile_piece); ?></td>
                              <td><?php echo e($cdcs->nbre_epi_piece); ?></td>
                              <td><?php echo e($cdcs->nbre_herbicides_post_levee); ?></td>
                              <td><?php echo e($cdcs->nbre_herbicides_pre_levee); ?></td>
                              <td><?php echo e($cdcs->nbre_herbicides_total); ?></td>
                              <td><?php echo e($cdcs->nbre_insecticides_type_1_traitement); ?></td>
                              <td><?php echo e($cdcs->nbre_insecticides_type_2_traitement); ?></td>
                              <td><?php echo e($cdcs->nbre_insecticides_type_3_traitement); ?></td>
                              <td><?php echo e($cdcs->nbre_insecticides_type_1_specifiques_traitement); ?></td>
                              <td><?php echo e($cdcs->nbre_insecticides_type_2_specifiques_traitement); ?></td>
                              <td><?php echo e($cdcs->nbre_insecticides_type_3_specifiques_traitement); ?></td>
                              <td><?php echo e($cdcs->nbre_sac_engrais_npk_fu_50kg); ?></td>
                              <td><?php echo e($cdcs->nbre_sac_engrais_uree_50kg); ?></td>
                              <td><?php echo e($cdcs->total_engrais_cdc); ?></td>
                              <td><?php echo e($cdcs->total_semence_cdc); ?></td>
                              <td><?php echo e($cdcs->total_insecticide_cdc); ?></td>
                              <td><?php echo e($cdcs->total_cdc); ?></td>
                            </tr>   
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
                    </table>
            ...
            <!-- <form action="<?php echo e(route('search_cdc')); ?>" method="get">
               <div class="row" style="display:flex;">
                <div class="mb-3 col-4" style="margin-top:7px;">
                  <label for="exampleFormControlSelect1" >Campagne :</label>
                  <select class="form-select form-control" name="search_cdc" id="myselection" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_cdcZ" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_cdcS" id="exampleFormControlSelect1" aria-label="Default select example">
          ...
          function calculateTotal(selectedCampagne, selectedZone, selectedSection) {
              ...
              $('#clcTableBody tr:visible').each(function () {
                  ...
                  if ((!selectedCampagne || rowCampagne === selectedCampagne) &&
                      ...
                      var rowTotalText = $(this).find('td:nth-child(24)').text().trim();
...
<?php /**PATH /home/c1735160c/public_html/fasocoton/resources/views/MobiagriDashboard/cdc.blade.php ENDPATH**/ ?>