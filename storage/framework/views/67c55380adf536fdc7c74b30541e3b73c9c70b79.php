...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="<?php echo e(asset('MobiagriDashboard/assets/img/logo_fasocoton.jpeg')); ?>" />
    <!-- Fonts -->
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('MobiagriDashboard/assets/vendor/fonts/boxicons.css')); ?>" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('MobiagriDashboard/assets/vendor/css/core.css')); ?>"
        class="template-customizer-core-css" />
    <link rel="stylesheet"
        href="<?php echo e(asset('MobiagriDashboard/assets/vendor/css/theme-default.css')); ?>"
        class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?php echo e(asset('MobiagriDashboard/assets/css/demo.css')); ?>" />

    <!-- Vendors CSS -->
    <link rel="stylesheet"
        href="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css')); ?>" />

    <link rel="stylesheet"
        href="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/apex-charts/apex-charts.css')); ?>" />
...
<body>
          ...
          <div class="layout-container">
            <!-- Menu -->
              ...
              <div class="layout-page">
                  ...
                  <!-- / Navbar -->
                  <div class="my-4 d-flex justify-content-center align-item-center px-auto">
                    <div class="ms-4 container card text-start justify-content-start w-25">
                        <h4 class="text-primary mt-3">Mise en place</h4>
                    </div>
                </div>
                  <!-- Content wrapper -->
                  <div class="content-wrap container mt-4">
                    <div class="my-auto">
                        <div class="row">
                            ...
                            <?php if(Auth::user()->nom_role != 'ca'): ?>
                            <?php if(Auth::user()->nom_role == 'ZORGHO' OR Auth::user()->nom_role == 'TENKODOGO' OR Auth::user()->nom_role == 'MANGA' OR  Auth::user()->nom_role == 'KOMBISSIRI' OR Auth::user()->nom_role == 'PO'): ?>
                            <div class="col-4">
                                ...
                                <select class="form-select" name="by_zone" id="selectZoneClc">
                                    <option class="form-option" value="" selected>Selectionné une zone ...</option>
                                        ...
                                        <option class="form-option" value="<?php echo e(Auth::user()->nom_role); ?>">
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select" name="by_zone" id="selectZoneClc">
                                    <option class="form-option" value="" selected>Selectionné une zone ...</option>
                                    <?php $__currentLoopData = $zone_by_mise_en_place; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option class="form-option" value="<?php echo e($item->nom_zone); ?>">
                                            <?php echo e($item->nom_zone); ?>
                                ...
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0">
                                            <img src="<?php echo e(asset('MobiagriDashboard/assets/img/icons/unicons/farmerGroup.png')); ?>"
                                    ...
                                    <span class=" ">Valeur Total Mise en place</span>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu1" class="tab-pane fade">
                                    <table class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $total_int_scoop_23_24s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $total_int_scoop_23_24ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($total_int_scoop_23_24ss): ?>
                                                <tr>
                                                    <td><?php echo e($number1); ?></td>
                                                    <td><?php echo e(($total_int_scoop_23_24ss) ? $total_int_scoop_23_24ss : '--'); ?></td>
                                                </tr>
                                                <?php endif; ?>
                                                <?php $number1++;  ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div id="menu2" class="tab-pane fade">
                                <table class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $total_int_scoop_24_25s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $total_int_scoop_24_25ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($total_int_scoop_24_25ss): ?>
                                                <tr>
                                                    <td><?php echo e($number2); ?></td>
                                                    <td><?php echo e(($total_int_scoop_24_25ss) ? $total_int_scoop_24_25ss : '--'); ?></td>
                                                </tr>
                                                <?php endif; ?>
                                                <?php $number2++;  ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <style>
                        ...
                        <div id="start" style="display:flex; justify-content: space-between;">
                            <!--<div id="first" class="box-shadow fun-box">
                                ...
                                <h3 class="fun-number"><?php echo e(intVal($total_int_pro_23_24 + $total_int_pro_24_25)); ?></h3>
                                <span class="fun-text">Valeur Total Scoop</span>
                                <h3 class="fun-number"><?php echo e(intVal($total_int_scoop_23_24 + $total_int_scoop_24_25)); ?></h3>
                            </div>-->
                            <div id='second' class="box-shadow fun-box2" style="width: 350px;">
                                <span class="fun-text">Total Producteur 23-24</span>
                                <h3 class="fun-number"><?php echo e(number_format($total_int_pro_23_24)); ?></h3>
                                <span class="fun-text">Total Scoop 23-24</span>
                                <h3 class="fun-number"><?php echo e(number_format($total_int_scoop_23_24)); ?></h3>
                            </div>
                            <div id="first" class="box-shadow fun-box" style="width: 350px;">
                                <span class="fun-text">Superficies prévues (ha) 23-24</span>
                                <h3 class="fun-number"><?php echo e(number_format($total_int_prevu_23_24)); ?></h3>
                                <span class="fun-text">Superficies prévues (ha) 24-25</span>
                                <h3 class="fun-number"><?php echo e(number_format($total_int_prevu_24_25)); ?></h3>
                            </div>
                            <div id='thirty' class="box-shadow fun-box3" style="width: 350px;">
                                <span class="fun-text">Total Producteur 24-25</span>
                                <h3 class="fun-number"><?php echo e(number_format($total_int_pro_24_25)); ?></h3>
                                <span class="fun-text">Total Scoop 24-25</span>
                                <h3 class="fun-number"><?php echo e(number_format($total_int_scoop_24_25)); ?></h3>
                            </div>
                        </div>
                        <?php endif; ?>
                  <br>
                    <hr>
                            <table class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody class="table-border-bottom-0" id="clcTableBody">
                                    <?php $__currentLoopData = $mise_en_place; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mise_en_places): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td> <?php echo e($mise_en_places->nom_zone); ?> </td>
                                            <td> <?php echo e($mise_en_places->nom_section); ?> </td>
                                            <td><?php echo e($mise_en_places->campagne_coton); ?></td>
                                            <td><?php echo e($mise_en_places->prenom_producteur); ?>

                                                <?php echo e($mise_en_places->nom_producteur); ?></td>
                                            <td><?php echo e($mise_en_places->code_scoop_producteur); ?></td>
                                            <td><?php echo e($mise_en_places->nom_scoop); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_appareil_atomiseur_piece); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_appareil_dos_piece); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_appareil_pile_piece); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_epi_piece); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_herbicides_post_levee); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_herbicides_pre_levee); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_herbicides_total); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_insecticides_type_1_traitement); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_insecticides_type_2_traitement); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_insecticides_type_3_traitement); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_insecticides_type_1_specifiques_traitement); ?>

                                            </td>
                                            <td><?php echo e($mise_en_places->nbre_insecticides_type_2_specifiques_traitement); ?>

                                            </td>
                                            <td><?php echo e($mise_en_places->nbre_insecticides_type_3_specifiques_traitement); ?>

                                            </td>
                                            <td><?php echo e($mise_en_places->nbre_sac_engrais_npk_fu_50kg); ?></td>
                                            <td><?php echo e($mise_en_places->nbre_sac_engrais_uree_50kg); ?></td>
                                            <td><?php echo e($mise_en_places->total_engrais); ?></td>
                                            <td><?php echo e($mise_en_places->total_semence); ?></td>
                                            <td><?php echo e($mise_en_places->total_insecticide); ?></td>
                                            <td><?php echo e($mise_en_places->total_montant_intrants); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
    ...
    <script src="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/jquery/jquery.js')); ?>">
    </script>
    <script src="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/popper/popper.js')); ?>">
    </script>
    <script src="<?php echo e(asset('MobiagriDashboard/assets/vendor/js/bootstrap.js')); ?>"></script>
    <script
        src="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js')); ?>">
    </script>
    ...
    <!-- Vendors JS -->
    <script
        src="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/apex-charts/apexcharts.js')); ?>">
    </script>
    ...
    $(document).ready(function () {
        ...
        function updateMiseEnPlaceTable(selectedCampagne, selectedZone, selectedSection) {
            ...
            tableRows.each(function() {
                var rowCampagne = $(this).find('td:nth-child(3)').text().trim();
...
<?php /**PATH /home/c1735160c/public_html/fasocoton/resources/views/MobiagriDashboard/mise_en_place.blade.php ENDPATH**/ ?>