        ...
        <div class="layout-page">
          ...
          <div class="my-4 d-flex justify-content-center align-item-center px-auto">
            <div class="ms-4 container card text-start justify-content-start w-25">
                <h4 class="text-primary mt-3">Besoin Complementaire</h4>
            </div>
          </div>
          <!-- Content wrapper -->
          <div class="content-wrapper">
              ...
              <div class="row pull-right" style="display:flex;" >
                 ...
                 <?php
                    $segment = request()->input('search_zone_bc');
                            //echo $segment; // article
                    $campa = request()->input('search_campagne_bc');
                    ?>
            <div class="container flex-grow-1 container-p-y">
              <div class="col-lg-4 mt-2 order-0">
                <div class="card shadow-none bg-transparent border border-primary mb-3">
                    <div class="card-body">
                        ...
                        <span class=" ">Valeur Total Besoin complemetaire</span>
                    ...
                    <table class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th>Total Besoin complementaire </th>


                        </tr>
                      </thead>
                      <tbody class="table-border-bottom-0" id="clcTableBody">
                        <?php $__currentLoopData = $besoin_complementaire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $besoin_complementaires): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                
                              <td><?php echo e($besoin_complementaires->nom_zone); ?></td>
                              <td><?php echo e($besoin_complementaires->nom_section); ?></td>
                              <td><?php echo e($besoin_complementaires->campagne_coton); ?></td>
                              <td><?php echo e($besoin_complementaires->prenom_producteur); ?> <?php echo e($besoin_complementaires->nom_producteur); ?></td>
                              <td><?php echo e($besoin_complementaires->code_scoop_producteur); ?></td>
                              <td><?php echo e($besoin_complementaires->nom_scoop); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_appareil_atomiseur_piece); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_appareil_dos_piece); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_appareil_pile_piece); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_epi_piece); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_herbicides_post_levee); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_herbicides_pre_levee); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_herbicides_total); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_insecticides_type_1_traitement); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_insecticides_type_2_traitement); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_insecticides_type_3_traitement); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_insecticides_type_1_specifiques_traitement); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_insecticides_type_2_specifiques_traitement); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_insecticides_type_3_specifiques_traitement); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_sac_engrais_npk_fu_50kg); ?></td>
                              <td><?php echo e($besoin_complementaires->nbre_sac_engrais_uree_50kg); ?></td>
                              <td><?php echo e($besoin_complementaires->total_engrais); ?></td>
                              <td><?php echo e($besoin_complementaires->total_semence); ?></td>
                              <td><?php echo e($besoin_complementaires->total_insecticide); ?></td>
                              <td><?php echo e($besoin_complementaires->total_montant_intrants); ?></td>
                            </tr>   
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
                    </table>
...
<?php /**PATH /home/c1735160c/public_html/fasocoton/resources/views/MobiagriDashboard/besoin_complementaire.blade.php ENDPATH**/ ?>