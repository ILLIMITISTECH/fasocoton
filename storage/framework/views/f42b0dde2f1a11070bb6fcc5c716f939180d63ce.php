...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <table class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody class="table-border-bottom-0" id="clcTableBody">
                                <?php $__currentLoopData = $clc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clcs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($clcs->nom_zone); ?></td>
                                        <td><?php echo e($clcs->nom_section); ?></td>
                                        <td><?php echo e($clcs->nom_producteur); ?> <?php echo e($clcs->prenom_producteur); ?></td>
                                        <td><?php echo e($clcs->code_scoop_producteur); ?></td>
                                        <td><?php echo e($clcs->nom_scoop); ?></td>
                                        <td><?php echo e($clcs->campagne_coton); ?></td>
                                        <td><?php echo e($clcs->nbre_appareil_atomiseur_piece); ?></td>
                                        <td><?php echo e($clcs->nbre_appareil_dos_piece); ?></td>
                                        <td><?php echo e($clcs->nbre_appareil_pile_piece); ?></td>
                                        <td><?php echo e($clcs->nbre_epi_piece); ?></td>
                                        <td><?php echo e($clcs->nbre_herbicides_post_levee); ?></td>
                                        <td><?php echo e($clcs->nbre_herbicides_pre_levee); ?></td>
                                        <td><?php echo e($clcs->nbre_herbicides_total); ?></td>
                                        <td><?php echo e($clcs->nbre_insecticides_type_1_traitement); ?></td>
                                        <td><?php echo e($clcs->nbre_insecticides_type_2_traitement); ?></td>
                                        <td><?php echo e($clcs->nbre_insecticides_type_3_traitement); ?></td>
                                        <td><?php echo e($clcs->nbre_insecticides_type_1_specifiques_traitement); ?></td>
                                        <td><?php echo e($clcs->nbre_insecticides_type_2_specifiques_traitement); ?></td>
                                        <td><?php echo e($clcs->nbre_insecticides_type_3_specifiques_traitement); ?></td>
                                        <td><?php echo e($clcs->nbre_sac_engrais_npk_fu_50kg); ?></td>
                                        <td><?php echo e($clcs->nbre_sac_engrais_uree_50kg); ?></td>
                                        <td><?php echo e($clcs->total_engrais); ?></td>
                                        <td><?php echo e($clcs->total_semence); ?></td>
                                        <td><?php echo e($clcs->total_insecticide); ?></td>
                                        <td><?php echo e($clcs->total_montant_intrants); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
            ...
            <script
                src="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/jquery/jquery.js')); ?>">
            </script>
            <script
                src="<?php echo e(asset('MobiagriDashboard/assets/vendor/libs/popper/popper.js')); ?>">
            </script>
            <script src="<?php echo e(asset('MobiagriDashboard/assets/vendor/js/bootstrap.js')); ?>">
            </script>
            <script
            ...
            <!-- Page JS -->
            <script src="<?php echo e(asset('MobiagriDashboard/assets/js/dashboards-analytics.js')); ?>">
            </script>
...
<?php /**PATH /home/c1735160c/public_html/fasocoton/resources/views/MobiagriDashboard/clc.blade.php ENDPATH**/ ?>