    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <!-- / Navbar -->
          <div class="my-3 d-flex justify-content-center align-item-center px-auto">
            <div class="ms-4 container card text-start justify-content-start w-25">
                <h4 class="text-primary mt-3">Production</h4>
            </div>
          </div>
          <!-- Content wrapper -->
          <div class="content-wrapper">
                ...
                <div class="row pull-right" style="display:flex;" >
                  <div class="content-wra container mt-4">
                    <div class="my-auto">
                        <div class="row">
                            <div class="col-4">
                 ...
                 <?php
                  $segment = request()->input('search_zone_production');
                  $campa = request()->input('search_campagne_production');
                    ...
                    <div class="col-lg-4 order-0">
                      <div class="card shadow-none bg-transparent border border-primary mb-3">
                          <div class="card-body">
                              ...
                              <span class=" ">Valeur Total Production 1er choix</span>
                    ...
                    <table class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                            ...
                            <th>Campagne</th>
                            <th>Prénom et Nom </th>
                            <th>Prix coton 1er choix</th>
                            <th>Quantité 1er choix</th>
                            <th>Total production 1er choix</th>
                            <th>Prix coton 2em choix</th>
                            <th>Quantité 2e choix</th>
                            <th>Total production 2em choix</th>
                            <th>Nom SCOOPS</th>
                            <th>Code SCOOPS</th>
                            <th>Type marché</th>
                      ...
                      <tbody class="table-border-bottom-0" id="clcTableBody">
                        <?php $__currentLoopData = $production; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <td><?php echo e($productions->nom_zone); ?></td>
                              <td><?php echo e($productions->nom_section); ?></td>
                              <td><?php echo e($productions->campagne_coton); ?></td>
                              <td><?php echo e($productions->prenom_producteur); ?> <?php echo e($productions->nom_producteur); ?></td>
                              <td><?php echo e($productions->prix_coton_1er_choix); ?></td>
                              <td><?php echo e($productions->qte_1er_choix); ?></td>
                              <td style="color:red;"><?php echo e((int)$productions->prix_coton_1er_choix * (int)$productions->qte_1er_choix); ?> </td>
                              <td><?php echo e($productions->prix_coton_2eme_choix); ?></td>
                              <td><?php echo e($productions->qte_2eme_choix); ?></td>
                              <td style="color:red;" ><?php echo e((int)$productions->prix_coton_2eme_choix * (int)$productions->qte_2eme_choix); ?></td>
                              <td><?php echo e($productions->nom_scoop); ?></td>
                              <td><?php echo e($productions->code_scoop_producteur); ?></td>
                              <td><?php echo e($productions->type_marche); ?></td>
                            </tr>   
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
                    </table>
          ...
          function calculateTotal(selectedCampagne, selectedZone, selectedSection) {
              ...
              $('#clcTableBody tr:visible').each(function () {
                  ...
                  if ((!selectedCampagne || rowCampagne === selectedCampagne) &&
                      ...
                      var rowTotalText = $(this).find('td:nth-child(7)').text().trim();
...
<?php /**PATH /home/c1735160c/public_html/fasocoton/resources/views/MobiagriDashboard/production.blade.php ENDPATH**/ ?>