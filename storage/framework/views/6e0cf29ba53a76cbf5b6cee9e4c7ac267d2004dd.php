...
>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
                ...
                <div class="mt-4"></div>
                <small class="text-primary text-muted">Production valorisée</small>
                    <form action="<?php echo e(route('filtreproductionValorisee')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6" >
 ...
 <?php if(Auth::user()->nom_role == 'admin'): ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><br>
                                    <label for="exampleFormControlSelect1">Sélectionner l'option 1 </label>
                                    <select class="form-select" name="option" id="option1" aria-label="Default select example" required>
                                        <option value="">Options</option>
                                        <option value="1">Production totale</option>
                                        <option value="2">Prix du coton</option>
                                        <option value="3">Production valorisée</option>
                                    </select>
                                </div>
                            </div>
...
<?php /**PATH /home/c1735160c/public_html/fasocoton/resources/views/MobiagriDashboard/production_valorisee.blade.php ENDPATH**/ ?>