...
class OdataController extends Controller
{
    ...
    //     }
       ...
       //$response_l = Http::get('http://41.219.14.123:5779/api/marcheEnDirect/GetFixCoursIndice');
     // echo $response;
   // Http::get('http://41.219.14.123:5779/api/marcheEnDirect/GetFixCoursIndice');
      // $quizzes_l = json_decode($response_l->body());
        ...
        $proh = 0;
            ...
            ->select('producteurs.id', 'producteurs.genre', 'producteurs.closed', 'producteurs.actif'
            , 'producteurs.owner_name', 'producteurs.prenom_producteur','producteurs.nom_producteur',
            'producteurs.genre', 'producteurs.campagne_coton')
            //'scoops.code_scoop', 'scoops.closed', 'scoops.zone', 'scoops.closed', 'scoops.owner_name')
           ...
           // 'scoops.code_scoop', 'scoops.closed', 'scoops.zone', 'scoops.closed', 'scoops.owner_name')
            ...
            $scoops = DB::table('scoops')->where('closed', 'false')->where('code_scoop','<>','---')->where('owner_name','<>','demo')->where('campagne_coton', '=' , '23-24')->get();
            ...
            'intrant_equipements.closed', 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed', 'scoops.owner_name', 'intrant_equipements.owner_name')
            ...
            'intrant_equipements.closed', 'intrant_equipements.owner_name')
            // , 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            // ->join('scoops', 'scoops.code_scoop', 'intrant_equipements.code_scoop_producteur')
            ->where('intrant_equipements.closed', 'false')
            // ->where('scoops.closed', 'false')
            //->where('intrant_equipements.closed', 'false')
           ...
           // $prix_coton_1_choix = DB::table('intrant_equipements')->where('closed', 'false')->sum('prix_coton_1er_choix');
            ...
            //parcelles
            $superficie_declarer = DB::table('parcelles')->where('closed', 'false')->where('owner_name', '<>', 'demo')->where('campagne_coton', '=', '23-24')->sum('supercifie_declaree');
            $superficie_mesuree = DB::table('parcelles')->where('closed', 'false')->where('owner_name', '<>', 'demo')->where('campagne_coton', '=', '23-24')->sum('superficie_mesuree_ha');
            
            //$superficie_declarer = DB::table('parcelles')
           // ->select('parcelles.id', 'parcelles.supercifie_declaree','parcelles.case_id_scoop_selectionne',
            //'parcelles.closed', 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            //->join('scoops', 'scoops.caseid', 'parcelles.case_id_scoop_selectionne')
           // ->where('parcelles.closed', 'false')
           // ->where('scoops.closed', 'false')
            //->where('scoops.zone', 'like', '%'.$searchZ.'%')
           // ->sum('parcelles.supercifie_declaree');
            
            //$superficie_mesuree = DB::table('parcelles')->where('closed', 'false')->orWhere('campagne', 'like', '%'.$search.'%')->sum('superficie_mesuree_ha');
           // $superficie_mesuree = DB::table('parcelles')
           // ->select('parcelles.id', 'parcelles.superficie_mesuree_ha','parcelles.case_id_scoop_selectionne',
            //'parcelles.closed', 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            //->join('scoops', 'scoops.caseid', 'parcelles.case_id_scoop_selectionne')
            //->where('parcelles.closed', 'false')
            //->where('scoops.closed', 'false')
    ...
    //     $proh = 0;
            ...
            // $producteursH = DB::table('producteurs')
            // //->where('genre', 'homme')->where('closed', 'false')
            // ->select('producteurs.id', 'producteurs.genre', 'producteurs.closed', 'scoops.code_scoop', 'scoops.section',
            // 'scoops.zone', 'scoops.closed', 'scoops.owner_name', 'producteurs.owner_name')
            // ->join('scoops', 'scoops.code_scoop', 'producteurs.code_scoop_producteur')
            // ->where('producteurs.closed', 'false')
            // ->where('scoops.closed', 'false')
            ...
            // $producteursF = DB::table('producteurs')
            // //->where('genre', 'femme')->where('closed', 'false')
            // ->select('producteurs.id', 'producteurs.genre', 'producteurs.closed', 'scoops.code_scoop', 
            // 'scoops.section', 'scoops.zone', 'scoops.closed', 'scoops.owner_name', 'producteurs.owner_name')
            // ->join('scoops', 'scoops.code_scoop', 'producteurs.code_scoop_producteur')
            // ->where('producteurs.closed', 'false')
            // ->where('scoops.closed', 'false')
            // ->where('scoops.zone', Auth::user()->nom_role)
           ...
           // $mise_en_place_total_mp = 0; //DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'mise_en_place')->sum('total_mp');
            ...
            //visite et suivi du parasitisme
            $superficie_perdue = DB::table('visite_paracitismes')->where('owner_name',  '<>',  'demo')->where('closed', 'false')->sum('superficie_perdue');

            //parcelles
            $superficie_declarer = DB::table('parcelles')->where('closed', 'false')->where('owner_name',  '<>',  'demo')->sum('supercifie_declaree');
            $superficie_mesuree = DB::table('parcelles')->where('closed', 'false')->where('owner_name',  '<>',  'demo')->sum('superficie_mesuree_ha');
    ...
    public function prodGrpmt()
    {
        ...
        ->select('producteurs.campagne_coton', 'producteurs.owner_name')
    ...
    public function adminFiltreGroupement(Request $request)
    {
        ...
        $campagnes = DB::table('producteurs')->select('campagne_coton')->where('campagne_coton', '<>', '')->where('campagne_coton', '<>', '---')->groupBy('campagne_coton')->get();
        $sections = DB::table('scoops')->select('section')->where('zone', Auth::user()->nom_role)->where('closed', 'false')->where('code_scoop', '<>', '---')->where('owner_name', '<>', 'demo')->groupBy('section')->get();
    ...
    public function superficies()
    {
        $campagnes = DB::table('producteurs')
            ...
            ->where('actif', 1)
            ->where('closed', 'false')
            ->where('owner_name', '<>', 'demo')->groupBy('campagne_coton')->get();
        
        if(Auth::user()->nom_role == 'admin'){
           $scoops = DB::table('scoops')->where('closed', 'false')->where('code_scoop', '<>', '---')->where('owner_name', '<>', 'demo')->get(); 
        }elseif(Auth::user()->nom_role == 'ca'){
        ...
        return view('MobiagriDashboard.superficie', compact('campagnes', 'scoops'));
    }
    ...
    // dd($request->all());
        switch ($request->option) {
            case '1':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('closed', 'false')->where('superficie_prevu_producteur', '<>', '')->where('superficie_prevu_producteur', '<>', '---')->where('campagne_coton', $request->campagne)->where('owner_name', '<>', 'demo')->get();
                    $dataCount = $datas->sum('superficie_prevu_producteur');
                    
                } elseif (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('owner_name', $owner_name)->where('closed', 'false')->where('superficie_prevu_producteur', '<>', '')->where('superficie_prevu_producteur', '<>', '---')->where('campagne_coton', $request->campagne)->get();
                    $dataCount = $datas->sum('superficie_prevu_producteur');
                }else{
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_zone', Auth::user()->nom_role)->where('closed', 'false')->where('superficie_prevu_producteur', '<>', '')->where('superficie_prevu_producteur', '<>', '---')->where('campagne_coton', $request->campagne)->where('owner_name', '<>', 'demo')->get();
                    $dataCount = $datas->sum('superficie_prevu_producteur');
                }
                break;
            case '2':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('supercifie_declaree', '<>', '')->where('supercifie_declaree', '<>', '---')->where('owner_name', '<>', 'demo')->get();
                    $dataCount = $datas->sum('supercifie_declaree');
                } elseif (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('supercifie_declaree', '<>', '')->where('supercifie_declaree', '<>', '---')->where('owner_name', $owner_name)->get();
                    $dataCount = $datas->sum('supercifie_declaree');
                }else{
                    $datas = DB::table('parcelles')->join('scoops', 'scoops.code_scoop', 'parcelles.code_scoop')->select('parcelles.campagne_coton', 'parcelles.nom_prenom_producteur', 'parcelles.supercifie_declaree')->where('parcelles.closed', 'false')->where('scoops.code_scoop', $request->codeScoop)->where('parcelles.campagne_coton', $request->campagne)->where('parcelles.supercifie_declaree', '<>', '')->where('parcelles.supercifie_declaree', '<>', '---')->where('parcelles.owner_name', '<>', 'demo')->where('scoops.zone', Auth::user()->nom_role)->where('parcelles.owner_name', '<>', 'demo')->get();
                    $dataCount = DB::table('parcelles')->join('scoops', 'scoops.code_scoop', 'parcelles.code_scoop')->select('parcelles.campagne_coton', 'parcelles.nom_prenom_producteur', 'parcelles.supercifie_declaree')->where('parcelles.closed', 'false')->where('parcelles.campagne_coton', $request->campagne)->where('parcelles.supercifie_declaree', '<>', '')->where('parcelles.supercifie_declaree', '<>', '---')->where('parcelles.owner_name', '<>', 'demo')->where('scoops.zone', Auth::user()->nom_role)->where('parcelles.owner_name', '<>', 'demo')->sum('parcelles.supercifie_declaree');
                }
            ...
            case '3':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    ...
                    $superficieSaisie = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', '<>', 'demo')->sum('mesure_saisie');
                    ...
                    $superficieSaisie = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', $owner_name)->sum('mesure_saisie');
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('superficie_mesuree_ha', '<>', '')->where('superficie_mesuree_ha', '<>', '---')->where('owner_name', $owner_name)->get();
                    $superficieMesureeHa = $datas->sum('superficie_mesuree_ha');
            ...
            case '5':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    ...
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('superficie_perdue', '<>', '')->where('superficie_perdue', '<>', '---')->where('owner_name', '<>', 'demo')->get();
                    ...
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('superficie_perdue', '<>', '')->where('superficie_perdue', '<>', '---')->where('owner_name', $owner_name)->get();
                    $dataCount = $datas->sum('superficie_perdue');
            ...
            case '6':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    ...
                    $superficieMesureeHa = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', '<>', 'demo')->sum('superficie_mesuree_ha');
                    ...
                    $superficieMesuree = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('owner_name', '<>', 'demo')->sum('superficie_mesuree');                
                    
                    $dataCount = doubleval($superficieMesuree) * doubleval($valueCoef);
                    
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('superficie_mesuree', '<>', '')->where('superficie_mesuree', '<>', '---')->where('owner_name', '<>', 'demo')->get();                
                    
                } elseif (Auth::user()->nom_role == 'ca') {
                    
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    
                    $superficieDeclarer = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', $owner_name)->sum('supercifie_declaree');

                    $superficieMesureeHa = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', $owner_name)->sum('superficie_mesuree_ha');
                    ...
                    $superficieMesuree = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('owner_name', $owner_name)->sum('superficie_mesuree');                
                    
                    $dataCount = doubleval($superficieMesuree) * doubleval($valueCoef);
                    
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('superficie_mesuree', '<>', '')->where('superficie_mesuree', '<>', '---')->where('owner_name', $owner_name)->get();                
                
                    
                }else{
                    
                    $superficieDeclarer = DB::table('parcelles')->join('scoops', 'scoops.code_scoop', 'parcelles.code_scoop')->where('parcelles.closed', 'false')->where('parcelles.campagne_coton', $request->campagne)->where('supercifie_declaree', '<>', '')->where('supercifie_declaree', '<>', '---')->where('scoops.zone', Auth::user()->nom_role)->where('parcelles.owner_name', '<>', 'demo')->sum('parcelles.supercifie_declaree');

                    $superficieMesureeHa = DB::table('parcelles')->join('scoops', 'scoops.code_scoop', 'parcelles.code_scoop')->where('parcelles.closed', 'false')->where('parcelles.campagne_coton', $request->campagne)->where('superficie_mesuree_ha', '<>', '')->where('superficie_mesuree_ha', '<>', '---')->where('scoops.zone', Auth::user()->nom_role)->where('parcelles.owner_name', '<>', 'demo')->sum('superficie_mesuree_ha');
            ...
            case '7':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('choix_formulaire_remplir', 'mise_en_place')->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('total_montant_intrants', '<>', '')->where('total_montant_intrants', '<>', '---')->where('owner_name', '<>', 'demo')->get();
                    $dataCount = $datas->sum('superficie_prevu_producteur');
                    
                    // dd($dataCount);
                }elseif (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('choix_formulaire_remplir', 'mise_en_place')->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('total_montant_intrants', '<>', '')->where('total_montant_intrants', '<>', '---')->where('owner_name', $owner_name)->get();
                    $dataCount = $datas->sum('superficie_prevu_producteur');
                }
                else{
                    
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'mise_en_place')->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('total_montant_intrants', '<>', '')->where('total_montant_intrants', '<>', '---')->where('owner_name', '<>', 'demo')->get();
                    $dataCount = $datas->sum('superficie_prevu_producteur');
                }
            ...
            case '8':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    ...
                    $superficieMesuree = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', '<>', 'demo')->sum('superficie_mesuree');
                    $superficiePerdue = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', '<>', 'demo')->sum('superficie_perdue');
                    ...
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $superficieMesuree = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', $owner_name)->sum('superficie_mesuree');
                    $superficiePerdue = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('owner_name', $owner_name)->sum('superficie_perdue');
                    $dataCount = doubleval($superficieMesuree) - doubleval($superficiePerdue);
                    $datas = DB::table('parcelles')->where('code_scoop', $request->codeScoop)->where('closed', 'false')->where('campagne_coton', $request->campagne)->where('superficie_mesuree', '<>', '')->where('superficie_mesuree', '<>', '---')->where('owner_name', $owner_name)->get();
                    ...
                    $superficieMesuree = DB::table('parcelles')->join('scoops', 'scoops.code_scoop', 'parcelles.code_scoop')->where('scoops.code_scoop', $request->codeScoop)->where('parcelles.closed', 'false')->where('parcelles.campagne_coton', $request->campagne)->where('scoops.zone', Auth::user()->nom_role)->where('parcelles.owner_name', '<>', 'demo')->sum('superficie_mesuree');
                    $superficiePerdue = DB::table('parcelles')->join('scoops', 'scoops.code_scoop', 'parcelles.code_scoop')->where('scoops.code_scoop', $request->codeScoop)->where('parcelles.closed', 'false')->where('parcelles.campagne_coton', $request->campagne)->where('scoops.zone', Auth::user()->nom_role)->where('parcelles.owner_name', '<>', 'demo')->sum('superficie_perdue');
                    $dataCount = doubleval($superficieMesuree) - doubleval($superficiePerdue);
                    $datas = DB::table('parcelles')->join('scoops', 'scoops.code_scoop', 'parcelles.code_scoop')->select('parcelles.campagne_coton', 'parcelles.nom_prenom_producteur', 'parcelles.superficie_mesuree')->where('scoops.code_scoop', $request->codeScoop)->where('parcelles.closed', 'false')->where('parcelles.campagne_coton', $request->campagne)->where('parcelles.superficie_mesuree', '<>', '')->where('parcelles.superficie_mesuree', '<>', '---')->where('scoops.zone', Auth::user()->nom_role)->where('parcelles.owner_name', '<>', 'demo')->get();
                }
    ...
    public function productionValorisee()
    {
        ...
        return view('MobiagriDashboard.production_valorisee', compact('campagnes'));
    }
        ...
        switch ($request->option) {
            case '1':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    ...
                    $value1 = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_1er_choix');
                    $value2 = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_2eme_choix');
                    
                    $datas = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('qte_1er_choix', '<>', '0')->where('qte_1er_choix', '<>', '---')->where('campagne_coton', $request->campagne)->get();
                    $datas2 = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('qte_2eme_choix', '<>', '0')->where('qte_2eme_choix', '<>', '---')->where('campagne_coton', $request->campagne)->get();
                } elseif (Auth::user()->nom_role == 'ca') {
                    ...
                    $value1 = DB::table('intrant_equipements')->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_1er_choix');
                    $value2 = DB::table('intrant_equipements')->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_2eme_choix');
                    
                    $datas = DB::table('intrant_equipements')->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('qte_1er_choix', '<>', '0')->where('qte_1er_choix', '<>', '---')->where('campagne_coton', $request->campagne)->get();
                    $datas2 = DB::table('intrant_equipements')->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('qte_2eme_choix', '<>', '0')->where('qte_2eme_choix', '<>', '---')->where('campagne_coton', $request->campagne)->get();
                }
            ...
            case '2':
                ...
                $value1 = DB::table('intrant_equipements')->select('prix_coton_1er_choix')->where('closed', 'false')->where('prix_coton_1er_choix', '<>', '---')->where('prix_coton_1er_choix', '<>', '')->where('prix_coton_1er_choix', '<>', '0')->where('campagne_coton', $request->campagne)->groupBy('prix_coton_1er_choix')->orderBy('prix_coton_1er_choix', 'desc')->limit(1)->first();
                $value2 = DB::table('intrant_equipements')->select('prix_coton_2eme_choix')->where('closed', 'false')->where('prix_coton_2eme_choix', '<>', '---')->where('prix_coton_2eme_choix', '<>', '')->where('prix_coton_2eme_choix', '<>', '0')->where('campagne_coton', $request->campagne)->groupBy('prix_coton_2eme_choix')->orderBy('prix_coton_2eme_choix', 'asc')->limit(1)->first();
                // if (condition) {
                //     # code...
                // }
                //  dd($value2->prix_coton_2eme_choix);
                // if(Auth::user()->nom_role == 'admin'){
                //     $value1 = DB::table('intrant_equipements')->select('prix_coton_1er_choix')->where('closed', 'false')->where('prix_coton_1er_choix', '<>', '---')->where('campagne_coton', $request->campagne)->groupBy('prix_coton_1er_choix')->orderBy('prix_coton_1er_choix', 'desc')->limit(1)->first();
                //     $value2 = DB::table('intrant_equipements')->select('prix_coton_2eme_choix')->where('closed', 'false')->where('prix_coton_2eme_choix', '<>', '---')->where('campagne_coton', $request->campagne)->groupBy('prix_coton_2eme_choix')->orderBy('prix_coton_2eme_choix', 'desc')->limit(1)->first();
                // } elseif (Auth::user()->nom_role == 'ca') {
                ...
                // }
                // else{
                //     $value1 = DB::table('intrant_equipements')->select('prix_coton_1er_choix')->where('nom_zone', Auth::user()->nom_role)->where('closed', 'false')->where('prix_coton_1er_choix', '<>', '---')->where('campagne_coton', $request->campagne)->groupBy('prix_coton_1er_choix')->orderBy('prix_coton_1er_choix', 'desc')->limit(1)->first();
                //     $value2 = DB::table('intrant_equipements')->select('prix_coton_2eme_choix')->where('nom_zone', Auth::user()->nom_role)->where('closed', 'false')->where('prix_coton_2eme_choix', '<>', '---')->where('campagne_coton', $request->campagne)->groupBy('prix_coton_2eme_choix')->orderBy('prix_coton_2eme_choix', 'desc')->limit(1)->first();
            ...
            case '3':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    ...
                    $val1 = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_1er_choix');
                    $val2 = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_2eme_choix');
                    ...
                    $val1 = DB::table('intrant_equipements')->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_1er_choix');
                    $val2 = DB::table('intrant_equipements')->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->sum('qte_2eme_choix');
    ...
    public function productionRealisee()
    {
        ...
        // dd($campagnes);
        return view('MobiagriDashboard.production_realisee', compact('campagnes','scoops'));
    }
    ...
    public function filtreProductionRealisee(Request $request)
    {
        ...
        switch ($request->option) {
            case '1':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('choix_formulaire_remplir', 'production')->where('owner_name','<>', 'demo')->where('type_marche', 'mag')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    ...
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_section', Auth::user()->section)->where('owner_name', '<>', 'demo')->where('choix_formulaire_remplir', 'production')->where('type_marche', 'mag')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    foreach ($datas as $value) {
                        $data = $value->nom_scoop;
                    }
                    if(isset($value->nom_scoop)){
                    ...
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_zone', Auth::user()->nom_role)->where('owner_name', '<>', 'demo')->where('choix_formulaire_remplir', 'production')->where('type_marche', 'mag')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    foreach ($datas as $value) {
                        $data = $value->nom_scoop;
                    }
                    if(isset($value->nom_scoop)){
            ...
            case '2':
                ...
                $title = 'Production CD';
                if(Auth::user()->nom_role == 'admin'){
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    foreach ($datas as $value) {
                        $data = $value->nom_scoop;
                    }
                    if(isset($value->nom_scoop)){
                    ...
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_section', Auth::user()->section)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    foreach ($datas as $value) {
                        $data = $value->nom_scoop;
                    }
                    if(isset($value->nom_scoop)){
                    ...
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    foreach ($datas as $value) {
                        $data = $value->nom_scoop;
                    }
                    if(isset($value->nom_scoop)){
            ...
            case '3':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'mag')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    $data2 = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    ...
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_section', Auth::user()->section)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'mag')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    $data2 = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_section', Auth::user()->section)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    ...
                    $datas = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'mag')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    $data2 = DB::table('intrant_equipements')->where('code_scoop_producteur', $request->codeScoop)->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'production')->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
            ...
            case '4':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    // $datas = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'entree_usine')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                     $datas = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'entree_usine')->where('type_marche', 'mag')->where('qte_1er_choix_mag', '<>', '')->where('qte_1er_choix_mag', '<>', '---')->where('qte_2eme_choix_mag', '<>', '')->where('qte_2eme_choix_mag', '<>', '---')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    foreach ($datas as $value) {
                        $data = $value->nom_scoop;
                    }
                    if(isset($value->nom_scoop)){
                    ...
                    $datas = DB::table('intrant_equipements')->where('nom_zone', Auth::user()->nom_role)->where('choix_formulaire_remplir', 'entree_usine')->where('type_marche', 'mag')->where('qte_1er_choix_mag', '<>', '')->where('qte_1er_choix_mag', '<>', '---')->where('qte_2eme_choix_mag', '<>', '')->where('qte_2eme_choix_mag', '<>', '---')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
                    foreach ($datas as $value) {
                        $data = $value->nom_scoop;
                    }
                    if(isset($value->nom_scoop)){
            ...
            case '5':
                ...
                if(Auth::user()->nom_role == 'admin'){
                    $datas = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'entree_usine')->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();;
                    ...
                    // $total = doubleval($qt1) + doubleval($qt2);
                    $datas = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'entree_usine')->where('nom_zone', Auth::user()->nom_role)->where('type_marche', 'cd')->where('owner_name', '<>', 'demo')->where('closed', 'false')->where('campagne_coton', $request->campagne)->get();
    ...
    public function clc()
    {
        if (Auth::user()->nom_role == 'admin') {
            $clc = DB::table('intrant_equipements')->where('closed', 'false')
                ->where('choix_formulaire_remplir', 'clc')->paginate(20);
    ...
    public function cdc()
    {
        ...
        if (Auth::user()->nom_role == 'admin') {
            $cdc = DB::table('intrant_equipements')->where('closed', 'false')
                ->where('choix_formulaire_remplir', 'cdc')->paginate(20);
    ...
    public function mise_en_place()
    {
        if (Auth::user()->nom_role == 'admin') {
            $mise_en_place = DB::table('intrant_equipements')
                ...
                ->where('choix_formulaire_remplir', 'mise_en_place')->paginate(20);
    ...
    public function besoin_complementaire()
    {
        ...
        if (Auth::user()->nom_role == 'admin') {
            $besoin_complementaire = DB::table('intrant_equipements')
                ->where('nom_producteur', '!=', null)
                ->where('prenom_producteur', '!=', null)
                ->where('closed', 'false')->where('choix_formulaire_remplir', 'besoins_complementaires')->paginate(20);
    ...
    // public function suivi_parasitisme()
    // {
    //     $suivi_parasitisme = DB::table('detail_scoops')->where('closed', 'false')->get();

    //     return view('MobiagriDashboard.suivi_parasitisme', compact('suivi_parasitisme'));
    // }
    
    public function formation()
    {
        if (Auth::user()->nom_role == 'admin') {
            $formations = DB::table('formations')->join('scoops', 'scoops.caseid', 'formations.case_id_scoop_selectionne')->where('formations.closed', 'false')->where('nom_prenom_formation', '<>', '')->where('formations.owner_name', '<>', 'demo')->paginate(20);
        } elseif (Auth::user()->nom_role == 'ca') {
            $owner_name = ' ' . Auth::user()->nom . '' . Auth::user()->prenom;
            $formations = DB::table('formations')->join('scoops', 'scoops.caseid', 'formations.case_id_scoop_selectionne')->where('formations.closed', 'false')->where('nom_prenom_formation', '<>', '')->where('formations.owner_name', $owner_name)->paginate(20);
        } else {
            $formations = DB::table('formations')->join('scoops', 'scoops.caseid', 'formations.case_id_scoop_selectionne')->where('formations.closed', 'false')->where('nom_prenom_formation', '<>', '')->where('formations.owner_name', '<>', 'demo')->where('scoops.zone', Auth::user()->nom_role)->groupBy('formations.case_id_scoop_selectionne')->paginate(20);
        }
    ...
    public function pluviometrie()
    {
        if (Auth::user()->nom_role == 'admin') {
            ...
            $owner_name = ' ' . Auth::user()->nom . '' . Auth::user()->prenom;
            $pluviometries = DB::table('hauteurs')->where('hauteur_deau', '<>', '---')->where('closed', 'false')->where('owner_name', $owner_name)->paginate(20);
        } else {
            // $pluviometries = DB::table('hauteurs')->join('scoops', 'scoops.owner_name', 'hauteurs.owner_name')->where('scoops.zone', 'MANGA')->where('hauteurs.closed', 'false')->where('hauteurs.owner_name', '<>', 'demo')->paginate(20);
            // dd($pluviometries);
            $pluviometries = DB::table('hauteurs')->where('closed', 'false')->where('hauteur_deau', '<>', '---')->where('owner_name', '<>', 'demo_illimitis')->where('owner_name', '<>', 'demo')->paginate(20);
        }
    ...
    public function pluviometrie_filter(Request $request)
    {
        if (Auth::user()->nom_role == 'ca') {
            $owner_name = ' ' . Auth::user()->nom . '' . Auth::user()->prenom;
            $pluviometries = DB::table('hauteurs')->where('campagne_coton', $request->search_campagne)->where('decade', $request->search_decade)->where('closed', 'false')->where('owner_name', $owner_name)->get();
        } else {
        ...
        // $search_campagne = $request->input('search_campagne');
        // $search_decade = $request->input('search_decade');
        // $pluviometrie = DB::table('hauteurs')->where('closed', 'false')
        // ->when(request()->has('search_campagne'), function($q){
        //     $q->where('campagne_coton', request('search_campagne'));
        // })
        // ->when(request()->has('search_decade'), function($q){
        //     $q->where('decade', request('search_decade'));
        // })
        // ->get();
    ...
    public function filtreSuiviParasitisme(Request $request)
    {
        ...
        switch ($request->option) {
            case '1':
                ...
                if (Auth::user()->nom_role == 'admin') {
                   ...
                   $dataCount = $datas->sum('nombre_de_parcelles_prcoces_suivies');
                    ...
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_prcoces_suivies');
                } else {
            ...
            case '2':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_normales_suivies');
                } else {
            ...
            case '3':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_tardives_suivies');
                } else {
            ...
            case '4':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_total_de_parcelles_suivies');
                } else {
            ...
            case '5':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_alises');
                } else {
            ...
            case '6':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_pucerons');
                } else {
            ...
            case '8':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_anomis_flava');
                } else {
            ...
            case '9':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_larves_helicoverpa');
                } else {
            ...
            case '10':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_larves_diparopsis');
                } else {
            ...
            case '11':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_larves_earias');
                } else {
            ...
            case '12':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_oeufs_de_carpophages');
                } else {
            ...
            case '13':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_pucerons_adultes');
                } else {
            ...
            case '14':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_jassides');
                } else {
            ...
            case '15':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_dysdercus');
                } else {
            ...
            case '16':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_bemisia_nymphes');
                } else {
            ...
            case '17':
                ...
                if (Auth::user()->nom_role == 'ca') {
                    $owner_name = ' '.Auth::user()->nom.''.Auth::user()->prenom;
                    $dataCount = DB::table('detail_scoops')->where('closed', 'false')->where('owner_name', $owner_name)->sum('nombre_de_parcelles_infestes_par_des_bemisia');
                } else {
    ...
    public function production()
    {
        ...
        if (Auth::user()->nom_role == 'admin') {
            $production = DB::table('intrant_equipements')->where('closed', 'false')
                ...
                ->where('choix_formulaire_remplir', 'production')->paginate(20);
     ...
     public function filtrer_production(Request $request)
    {
        ...
        if (Auth::user()->nom_role == 'admin') {
            ...
            $production_count1 = DB::table('intrant_equipements')->where('closed', 'false')
                ...
                ->when(request()->has('search_section_production'), function($q){
                $q->v('nom_section', request('search_section_production'));
                })
       ...
       $prixmp = 0;
        ...
        $quizzes_ara = array();
         foreach($quizzes as $quizze){
            ...
            //->select('producteurs.id', 'producteurs.genre', 'producteurs.closed')
            //'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            //->join('scoops', 'scoops.code_scoop', 'producteurs.code_scoop_producteur')
           // ->where('producteurs.closed', 'false')
           // ->where('scoops.closed', 'false')
           // ->where('producteurs.genre', 'homme')
            ...
            //->where('scoops.zone', 'like', '%'.$searchZ.'%')
            //->where('scoops.section', 'like', '%'.$searchS.'%')
          
            ->get();
            $producteursF = DB::table('producteurs')->select('producteurs.*')
            //->where('closed', 'false')->where('genre', 'femme')->orWhere('zone', 'like', '%'.$searchZ.'%')->orWhere('section', 'like', '%'.$searchS.'%')->get();
            //->select('producteurs.id', 'producteurs.genre', 'producteurs.closed')
            //, 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
           // ->join('scoops', 'scoops.code_scoop', 'producteurs.code_scoop_producteur')
           // ->where('producteurs.closed', 'false')
           ...
           // ->where('scoops.section', 'like', '%'.$searchS.'%')
            ...
            //intrant et equipement
            //$superficie_prevue = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('superficie_prevu_groupement');
            //$superficie_realise = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('superficie_realise_producteur');
            $superficie_prevue = DB::table('intrant_equipements')
            ->select('intrant_equipements.id', 'intrant_equipements.superficie_prevu_groupement','intrant_equipements.campagne_coton',
            'intrant_equipements.closed', 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            ->join('scoops', 'scoops.code_scoop', 'intrant_equipements.code_scoop_producteur')
           ...
           // ->where('scoops.section', 'like', '%'.$searchS.'%')
            ->where('intrant_equipements.campagne_coton', 'like', '%'.$search.'%')
            ->sum('intrant_equipements.superficie_realise_producteur');
            //$clc = DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'clc')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_clc');
            //$cdc = DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'cdc')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_cdc');
            //$besoin_complementaire = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'besoins_complementaires')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_bc');
            //$mise_en_place = DB::table('intrant_equipements')->where('choix_formulaire_remplir', 'mise_en_place')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_mp');
            
            //$clc_total_cls = DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'clc')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_clc');
            //$clc_total__montant_intrant = DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'clc')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_montant_intrants');
            //$clc = $clc_total_cls + $clc_total__montant_intrant;
            
            $clc_total_cls = DB::table('intrant_equipements')
            //->where('closed', 'false')->sum('total_clc');
            ->select('intrant_equipements.id', 'intrant_equipements.total_clc','intrant_equipements.campagne_coton',
            'intrant_equipements.closed', 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            ->join('scoops', 'scoops.code_scoop', 'intrant_equipements.code_scoop_producteur')
            ->where('intrant_equipements.closed', 'false')
           ...
           // $clc = $clc_total_cls + $clc_total__montant_intrant;
            ...
            //$besoin_complementaire_total_bc = 0; //DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'besoins_complementaires')->where('campagne_coton', 'like', '%'.$search.'%')->where('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_bc');
            //$besoin_complementaire_total__montant_intrant = DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'besoins_complementaires')->where('campagne_coton', 'like', '%'.$search.'%')->where('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_montant_intrants');
            //$besoin_complementaire = $besoin_complementaire_total_bc + $besoin_complementaire_total__montant_intrant;
           ...
           // $mise_en_place_total_mp = 0; //DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'mise_en_place')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_mp');
           // $mise_en_place_total__montant_intrant = DB::table('intrant_equipements')->where('closed', 'false')->where('choix_formulaire_remplir', 'mise_en_place')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('total_montant_intrants');
            //$mise_en_place = $mise_en_place_total_mp + $mise_en_place_total__montant_intrant;
            ...
            //$prevision_de_production = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('prevision_de_production_scoop');
            $prevision_de_production = DB::table('intrant_equipements')
            ->select('intrant_equipements.id', 'intrant_equipements.prevision_de_production_scoop','intrant_equipements.campagne_coton',
            'intrant_equipements.closed', 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            ->join('scoops', 'scoops.code_scoop', 'intrant_equipements.code_scoop_producteur')
            ...
            //$qte_1_choix = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('qte_1er_choix');
            //$qte_1_choix_mag = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('qte_1er_choix_mag');
            //$qte_2_choix = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('qte_2eme_choix');
            //$qte_2_choix_mag = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('qte_2eme_choix_mag');
            //$production_tonnes = $qte_1_choix + $qte_1_choix_mag + $qte_2_choix + $qte_2_choix_mag;
           // $prix_coton_1_choix = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('prix_coton_1er_choix');
            //$prix_coton_2_choix = DB::table('intrant_equipements')->where('closed', 'false')->where('campagne_coton', 'like', '%'.$search.'%')->orWhere('nom_zone', 'like', '%'.$searchZ.'%')->orWhere('nom_section', 'like', '%'.$searchS.'%')->sum('prix_coton_2eme_choix');
             $qte_1_choix = DB::table('intrant_equipements')
            //->where('closed', 'false')->sum('qte_1er_choix');
            ->select('intrant_equipements.id', 'intrant_equipements.qte_1er_choix','intrant_equipements.campagne_coton',
            'intrant_equipements.closed', 'scoops.code_scoop', 'scoops.section', 'scoops.zone', 'scoops.closed')
            ...
            //parcelles
            $superficie_declarer = DB::table('parcelles')->where('closed', 'false')
            ->where('campagne_coton', 'like', '%'.$search.'%')
           ...
           // ->sum('parcelles.supercifie_declaree');
            ...
            $superficie_mesuree = DB::table('parcelles')->where('closed', 'false')
            ->where('campagne_coton', 'like', '%'.$search.'%')
    ...
    {
         $search = $request->input('search_campagne_zone');
       ...
       $prixmp = 0;
        ...
        $quizzes_ara = array();
         foreach($quizzes as $quizze){
            ...
            ->where('producteurs.genre', 'homme')
            ->where('scoops.zone', Auth::user()->nom_role)
            //->where('producteurs.campagne_coton', 'like', '%'.$search_producteur.'%')
            //->where('scoops.zone', 'like', '%'.$searchZ.'%')
            ->where('scoops.section', 'like', '%'.$searchS.'%')
    ...
    // public function filtrer_cdc(Request $request)
     //{
      //    $search_cdc = $request->input('search_cdc');
      //    $search_cdcZ = $request->input('search_cdcZ');
       //   $search_cdcS = $request->input('search_cdcS');

         // V.A.R.I.A.B.L.E.S
       //   $cdc = DB::table('intrant_equipements')
        //  ->where('campagne_coton', 'like', '%'.$search_cdc.'%')
        //  ->where('nom_zone', 'like', '%'.$search_cdcZ.'%')
        //  ->where('nom_section', 'like', '%'.$search_cdcS.'%')
        //  ->where('closed', 'false')
        // ->where('choix_formulaire_remplir', 'cdc')->get();

        // return view('MobiagriDashboard.cdc', compact('cdc','search_cdc'));
     //}
   // public function filtrer_bc(Request $request)
    //{
        // $search_bc = $request->input('search_bc');
        // $search_bcZ = $request->input('search_bcZ');
        // $search_bcS = $request->input('search_bcS');

         // V.A.R.I.A.B.L.E.S
        // $besoin_complementaire = DB::table('intrant_equipements')
        // ->where('campagne_coton', 'like', '%'.$search_bc.'%')
        // ->orWhere('nom_zone', 'like', '%'.$search_bcZ.'%')->orWhere('nom_section', 'like', '%'.$search_bcS.'%')
       // ->where('nom_producteur', '!=', null)
       // ->where('prenom_producteur', '!=', null)
       // ->where('closed', 'false')->where('choix_formulaire_remplir', 'besoins_complementaires')->get();

       // return view('MobiagriDashboard.besoin_complementaire', compact('besoin_complementaire','search_bc'));
   // }
   // public function filtrer_mep(Request $request)
    //{
       //  $search_mep = $request->input('search_mep');
        // $search_mepZ = $request->input('search_mepZ');
        // $search_mepS = $request->input('search_mepS');

         // V.A.R.I.A.B.L.E.S
       //  $mise_en_place = DB::table('intrant_equipements')->where('closed', 'false')
       //  ->where('campagne_coton', 'like', '%'.$search_mep.'%')
       //  ->orWhere('nom_zone', 'like', '%'.$search_mepZ.'%')->orWhere('nom_section', 'like', '%'.$search_mepS.'%')
       // ->where('nom_producteur', '!=', null)
       // ->where('prenom_producteur', '!=', null)
       // ->where('choix_formulaire_remplir', 'mise_en_place')->get();

       // return view('MobiagriDashboard.mise_en_place', compact('mise_en_place','search_mep'));
   // }
    //public function filtrer_production(Request $request)
    //{
        // $search_production = $request->input('search_production');
        // $search_productionZ = $request->input('search_productionZ');
        // $search_productionS = $request->input('search_productionS');
         
         // V.A.R.I.A.B.L.E.S
        
       // $production = DB::table('intrant_equipements')->where('closed', 'false')
       // ->where('campagne_coton', 'like', '%'.$search_production.'%')
       // ->orWhere('nom_zone', 'like', '%'.$search_productionZ.'%')->orWhere('nom_section', 'like', '%'.$search_productionS.'%')
       // ->where('nom_producteur', '!=', null)
       // ->where('prenom_producteur', '!=', null)
      //  ->where('choix_formulaire_remplir', 'production')->get();

       // return view('MobiagriDashboard.production', compact('production','search_production'));
   // }
