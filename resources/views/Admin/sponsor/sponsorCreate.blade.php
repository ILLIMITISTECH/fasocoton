        ...
        <div class="main-panel">
          ...
          <div class="bdc">
            ...
            <div class="col-12 grid-margin stretch-card" style="margin-top:-40px">
                <div class="card">
                  <div class="card-body">
                    <p class="card-description">Remplissez ce formulaire pour créer un sponsor</p>
                    <form class="dropzone dropzone-custom needsclick add-professors forms-sample" id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('sponsors.store')}}">
                    {{ csrf_field() }}

                      <div class="form-group">
                        <label for="exampleInputName1">Nom du sponsor : (<span class="red">*</span>)</label>
                        <input type="text" name="nom_sponsor" class="form-control" id="exampleInputName1" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Logo : (<span class="red">*</span>)</label>
                        <input type="file" name="logo1" class="form-control" id="exampleInputName1" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Ordre  (<span class="red">*</span>)</label>
                    
                        <div class="">
                            <input type="number" name="ordre" class="form-control" placeholder="Ordre" />
                            </div>
                      </div>
                    ...
                    <button type="submit" class="btn mr-2"style="background:#F49800; color:white">Valider</button>
                      <a href="/sponsors" class="btn " style="background:#C92C2B; color:white">Quitter</a>
                    </form>
                  </div>
                </div>
            </div>
