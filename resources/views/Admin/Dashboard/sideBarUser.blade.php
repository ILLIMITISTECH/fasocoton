      ...
      <!-- partial -->
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="evenements">
                <ul class="nav flex-column sub-menu">
                  ...
                  <!-- <li class="nav-item"> <a class="nav-link" href="events/edit">Modifier</a></li> -->
            ...
            <li class="nav-item">
              <a class="nav-link" href="/espacepublicitaires">
                <span class="menu-title">Espace publicitaire</span>
                <i class="mdi mdi-home menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/pricings">
                <span class="menu-title">Pricing de l'event</span>
                <i class="mdi mdi-home menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
