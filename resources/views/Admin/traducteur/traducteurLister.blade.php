        ...
        <div class="main-panel">
          ...
          <div class="bd">
              <?php
                        ...
                        @if($even->status == 1)
             <h4 class="card-title"style="margin-left:30px;"> <br>Liste des traducteurs inscrites à {{$even->nom_event_fr}}</h4>
                      @else
                        ...
                        <table class="table">
                          ...
                          @foreach ($traducteurs as $traducteur)
                            <tr>
                                ...
                                <a href="{{route('traducteurs.edit', $traducteur->id)}}">
                                <button type="button" class="btn  btn-sm"style="background:#23B40B;color:white"><i class="bi bi-pen-fill"></i></i></button>
                              </a>
                               <form action="{{route('traducteurs.destroy', $traducteur->id)}}" method="post">
                                  {{ csrf_field() }}
                                  @method('DELETE')
