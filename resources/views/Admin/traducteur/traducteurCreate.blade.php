    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="bdc">
            <h4 class="card-title"style="margin-left:30px;"> <br>Ajouter un traducteur</h4>
          </div>
            <div class="col-12 grid-margin stretch-card"style="margin-top:-40px">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description">Remplissez ce formulaire pour ajouter un traducteur</p>
                    <form class="forms-sample"  action="{{route('traducteurs.store')}}" method="post" enctype="multipart/form-data">
                          {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="website" placeholder="example@...">
                           ...
                           <div class="form-group col-md-6">
                            <label for="exampleSelectGender">Téléphone du traducteur</label>
                            ...
                            <select  name="langue_id" id="stade_entreprise">
                                  <option value="traducteur">selectionner</option>
                      ...
                      <a href="/traducteurs" class="btn " style="background:#C92C2B; color:white">Quitter</a>
                    </form>
                  </div>
                </div>
            </div>
