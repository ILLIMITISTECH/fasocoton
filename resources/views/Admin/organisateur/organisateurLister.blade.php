        ...
        <div class="main-panel">
          ...
          <div class="bd">
              <?php
                        ...
                        @if($even->status == 1)
             <h4 class="card-title"style="margin-left:30px;"> <br>Liste des organisateurs inscrites à {{$even->nom_event_fr}}</h4>
                      @else
                        ...
                        <table class="table">
                          ...
                          @foreach ($organisateurs as $organisateur)
                            <tr>
                                ...
                                <td>{{$organisateur->portable}}</td>
                                <div class ="option-column">
                                <td class="text-center"> 
                                
                                <a href="{{route('organisateurs.edit', $organisateur->id)}}">
