    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="bdc">
            <h4 class="card-title"style="margin-left:30px;"> <br>Ajouter un type</h4>
          </div>
            <div class="col-12 grid-margin stretch-card"style="margin-top:-40px">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description">Remplissez ce formulaire pour ajouter un type</p>
                    <form class="forms-sample"  action="{{route('types.store')}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="libelle" id="exampleInputName1" placeholder="Name">
                      </div>  
                      
                        <button type="submit" class="btn mr-2"style="background:#F49800; color:white">Valider</button>
                      <a href="/types" class="btn " style="background:#C92C2B; color:white">Quitter</a>
                    </form>
                  </div>
                </div>
            </div>
