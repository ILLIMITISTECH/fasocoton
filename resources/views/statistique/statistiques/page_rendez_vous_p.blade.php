...
<div class="card">
<div class="card-header"><b style="font-size:20px;">Liste des participants</b>
<b>Ont demandé des B 2 B:</b> <b style="font-size:20px; color:green;"><strong>{{ count($participants) }}</strong></b></p></div>
<div class="card-body">
...
<table id="datatable-buttons" class="table table-striped table-bordered">
    <thead>
        <tr>
                ...
                <th id="a" style="font-size:12px;">Nom participant</th>
    ...
    @foreach($participants as $participant)
        <tr>
                ...
                <td id="b" style="font-size:12px;">{{ $participant->pays }}</td>
                <td id="c" style="font-size:12px;">{{ $participant->nom_entreprise }}</td>
                <td id="a" style="font-size:12px;">{{ $participant->tel_part }}</td>
                <td id="b" style="font-size:12px;">{{ $participant->email }}</td>
                <td id="c" style="font-size:12px;">{{ $participant->rendez_vous }}</td>
