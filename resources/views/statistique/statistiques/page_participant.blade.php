...
<center><h2 style="font-size:12px;"><strong><b style="font-size:20px;">Les Participants</b></strong></h2></center>
<div class="card">
<div class="card-header"><b style="font-size:20px;">Liste des participants</b></div>
<div class="card-body">

<table id="datatable-buttons" class="table table-striped table-bordered">
    <thead>
        <tr>
                <th id="a" style="font-size:12px;">id</th>
               
                 <th id="a" style="font-size:12px;">Nom</th>
                <th id="a" style="font-size:12px;">Prenom</th>
                 <th id="a" style="font-size:12px;">fonction</th>
                <th id="b" style="font-size:12px;">Email</th>
                <th id="a" style="font-size:12px;">tel</th>
                <th id="c" style="font-size:12px;">Nom Entreprise</th>
               
                <th id="c" style="font-size:12px;">pays</th>
    ...
    @foreach($participants as $participant)
        <tr>
                <td id="b" style="font-size:12px;">{{ $participant->id }} </td>
               
                <td id="a" style="font-size:12px;">{{ $participant->nom }}</td>
                <td id="b" style="font-size:12px;">{{ $participant->prenom }} </td>
                <td id="b" style="font-size:12px;">{{ $participant->fonction }}</td>
                <td id="c" style="font-size:12px;">{{ $participant->email }}</td>
                <td id="a" style="font-size:12px;">{{ $participant->tel_part }}</td>
                <td id="a" style="font-size:12px;">{{ $participant->nom_entreprise }}</td>
                
                <td id="c" style="font-size:12px;">{{ $participant->pays }}</td>
