...
<div class="card">
<div class="card-header"><b style="font-size:20px;">Liste des entreprises</b></div>
<div class="card-body">
...
<table id="datatable-buttons" class="table table-striped table-bordered">
    <thead>
        <tr>
                ...
                <th id="c" style="font-size:12px;">user id</th>
    ...
    @foreach($entreprises as $entreprise)
        <tr>
                ...
                <td id="b" style="font-size:12px;">{{ $entreprise->user_id }}</td>
