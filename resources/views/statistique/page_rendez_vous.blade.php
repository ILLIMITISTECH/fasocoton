...
<center><h2 style="font-size:12px;"><strong style="font-size:30px;font-weight: normal;Color:#84009c;">STATISQUE DES ENTREPRISES</strong></h2></center><br><br><br>
<div class="card">
    <div class="card-header" style="background:#84009c; color:white;">
<p><b style="font-size:20px;font-weight:normal;">Liste des Entreprises :</b> <b style="font-size:20px; color:white;"><strong>{{ count($entrepriss) }}</strong></b></p></div>
<div class="card-body">
...
<table id="datatable-buttons" class="table table-striped table-bordered">
    ...
    <tbody>
    @foreach($entrepriss as $entreprise)
        <tr>

                <!--<td id="a" style="font-size:13px;">{{ $entreprise->prenom }}      {{ $entreprise->nom }}</td>-->
                <td id="b" style="font-size:13px;">{{ $entreprise->pays }}</td>
                <td id="c" style="font-size:13px;">{{ $entreprise->nom_entreprise }}</td>
                <td id="c" style="font-size:13px;">{{ $entreprise->secteur_a }}</td>
                <!--<td id="a" style="font-size:13px;">{{ $entreprise->email }} <br>{{ $entreprise->portable }}</td>-->
                <td id="c" style="font-size:13px;">{{ $entreprise->rendez_vous }}</td>
...
<div class="card-header" style="background:#84009c; color:white;">
<p><b style="font-size:20px;font-weight:normal;">Liste des Entreprises pour B2B :</b> <b style="font-size:20px; color:white;"><strong>{{ count($entreprises) }}</strong></b></p></div>
<div class="card-body">
