						...
						<div class="container" id="kt_content_container">
							...
							<div class="card bg-dark">
								...
								<div class="card-body p-lg-20">
									...
									<div class="mb-5">
										<!--begin::Title-->
										<h1 class="fs-2x w-bolder text-light mb-6">Bienvenue Fallou !</h1>
										<!--end::Title-->
										<!--begin::Text-->
										<p class="fw-bold text-light fs-4 mb-2">
                                            La phase de <b>suggestion et d’ajouts de rendez-vous</b> du Rebranding Africa Forum est toujours en cours.
                                            <br>Elle prendra fin le <span class="text-primary">20 Septembre </span> .                                    
                                         </p>
                                         <p class="fw-bold  text-lightfs-4 mb-2">
                                            Le comité d’organisation t’invite à  : 
                                            <ul>
                                                <li>Valider les <span class="text-primary">suggestions de rendez-vous</span> qui t’intérèssent ! </li>
                                                <li>Parcourir le catalogue des entreprises participantes et ajouter des <span class="text-primary">souhaits de rendez-vous</span> </li>
                                            </ul>
							...
							<div class="card">
								...
								<div class="card-body p-lg-20">
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td> <h4>Voir mes suggestions de rendez vous : </h4> </td>
                                            <td class="btn-td"><button type="button" class="btn btn-primary">Suggestions de rendez-vous</button></td>
                                        </tr>
                                        <tr>
                                            <td><h4>Ajouter des souhaits de rendez-vous :</h4></td>
                                            <td class="btn-td"><button type="button" class="btn btn-danger">Catalogue des entreprises</button></td>
                                        </tr>
                                    </table>
								</div>
								<!--end::Card body-->
