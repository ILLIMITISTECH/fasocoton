		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid fs-6" id="kt_content">
        								...
        								<div class="card-body p-lg-20">
        									...
        									<div class="mb-5">
        										...
        										<p class="fw-bold text-light fs-4 mb-2">
                                                    <span class="text-light">{{ __('SICOT offers you a unique opportunity to meet professionals from a variety of fields, according to your areas of interest. This page displays the areas of interest that you have indicated during your registration. After registration closes, suggestions for B2B meetings will be proposed to you for validation. Before the beginning of the forum, you will have a detailed schedule of B2B meetings (date, room, time, table, company met).') }} </span>
						...
						<div class="container mt-5" id="kt_content_container">
							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<!--end::Sidebar-->
								<!--begin::Content-->
								@if($nomentreprise->partenaire_rencontrer_a)
								<div class="flex-lg-row-fluid ms-lg-12 mt-5">
                                <div>
								    
                                @else
                                <div class="flex-lg-row-fluid ms-lg-12 mt-5">
										<a href="/inscriptionstep3" type="button" class="btn btn-violet" style="position : absolute; right : 2%; z-index: 1;">Completer vos centres d'intêrets </a>
                                    <div>
                                @endif
                    ...
                    <li class="menu-item">
                    Partenaire : Partenaire : Salon International du Coton et du Textile
                    </li>
