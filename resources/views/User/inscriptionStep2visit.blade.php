...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed">
			...
			<div class="page d-flex flex-row flex-column-fluid">
                ...
                <div class="col-6 left-part">
                    ...
                    <?php 
						...
						<form class="row g-3" action="{{route('fonctionvisit.participant', $participant->id)}}" method="post">
                        {{ csrf_field() }}
                        
                            
                              <!-- <div class="col-md-12 mt-4">
                                <label for="inputEmail4" class="form-label required"> <h5>{{ __('Would you like to have a B2B meeting?')}}</h5>
                                </label>
                            ...
                            <div class="col-md-8">
                              ...
                              <input type="hidden" name="rendez_vous" value="SANS un planning B 2 B" class="form-control" id="inputText">
        ...
        {{ __('Would you like to take advantage of this kit?') }} O/N </label>
                           ...
                           <!--<div class="col-md-12 mt-4">
                                <label for="inputEmail4" class="form-label">Souhaitez-vous ajouter d’autres participants pour votre entreprise  / Do you want to add more participants for your company </label>
                                
                                 <select name="autre_participant" class="form-select" id="parti">
