									...
									<div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar" data-kt-sticky-offset="{default: false, xl: '80px'}" data-kt-sticky-width="{lg: '250px', xl: '325px'}" data-kt-sticky-left="auto" data-kt-sticky-top="90px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
										...
										<div class="card-body pt-0 p-10">
											...
											<div class="center-buttons">
												<a href="{{route('monprofil.edit', Auth::user()->id)}}" type="button" class="btn btn-violet">Modifier mon profil </a>
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer"style="background:#390c6e;width:300px;">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="color:white;margin-left:30px;font-family:Lucida Console,Courier New,monospace;">Details du profil</h3>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">Prénom :</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
