							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('editprofilPreinscris.update', $monprofil->id)}}">
                                                {{ csrf_field() }}
                                            ...
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class="required form-label">{{__('E-mail')}} :</label>
                                            ...
                                            @if($participant)
                                            <div class="mb-10">
                                              <label for="exampleFormControlInput1" class="required form-label">{{__('Function')}} :</label>
                                            ...
                                            @endif
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class="required form-label">{{__('Phone number')}} :</label>
