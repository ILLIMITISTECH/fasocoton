							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('mesparticipant.update', $mesparticipant->id)}}">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('First name')}} :</label>
                                                <input type="text" name="prenom" value="{{$mesparticipant->prenom}}" class="form-control form-control-solid" placeholder="prenom"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Last name')}} :</label>
                                                <input type="text" name="nom" value="{{$mesparticipant->nom}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('E-mail')}} :</label>
                                                <input type="email" name="email" value="{{$mesparticipant->email}}" class="form-control form-control-solid" placeholder="axel.n@illimitis.com"/>
                                            </div>
                                            <br>
                                            <hr>
                                            ...
                                            <a href="/monentreprises"><button type="button" class="btn btn-danger"> {{__('Quit')}}</button></a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
