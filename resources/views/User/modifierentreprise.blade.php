					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 mb-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder mt-1 mb-1 fs-2">Mon Profil
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0">Modifier le profil</h3>
											</div>
											<!--end::Card title-->
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('entrepriseD.updates', $entreprise->id)}}">
                                                {{ csrf_field() }}
                                               
                                           
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">Nom Entreprise :</label>
                                                <input type="text" name="nom_entreprise" value="{{$entreprise->nom_entreprise}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">Site web :</label>
                                                <input type="text" name="site" value="{{$entreprise->site}}" class="form-control form-control-solid" placeholder="Votre site web"/>
                                            </div>
                                             <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">Slogan :</label>
                                                <input type="text" name="slogan" value="{{$entreprise->slogan}}" class="form-control form-control-solid" placeholder="Votre slogan"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">Numéro de Téléphone :</label>
                                                <input type="text" name="tel_entreprise" value="{{$entreprise->tel_entreprise}}" class="form-control form-control-solid" placeholder="00221 782967825"/>
                                            </div>
                                            
                                            <!--<div class="mb-3">-->
                                            <!--    <label for="formFile" class="form-label">Télécharger une photo de profil au format carré (150 px * 150px) </label>-->
                                            <!--    <input class="form-control" name="photos" value="{{$entreprise->photos}}" type="file" id="formFile">-->
                                            <!--</div>-->
                                            <br>
                                            <hr>
                                            ...
                                            <!--    <input type="password" name="password" value="{{$entreprise->password}}" class="form-control form-control-solid" placeholder="********"/>-->
                                            <!--</div>-->
                                            <!--<div class="mb-10">-->
                                            <!--    <label for="exampleFormControlInput1" class="required form-label">Confirmer le mot de passe :</label>-->
                                            <!--    <input type="password" name="password_confirmation" value="{{$entreprise->password_confirmation}}" class="form-control form-control-solid" placeholder="********"/>-->
                                            <!--</div>-->
                                           <button class="btn btn-violet" type="submit"> Valider</button></a>
                                             <a href="/madelegations"><button class="btn btn-danger"> Quitter</button></a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
