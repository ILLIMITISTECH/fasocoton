					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 mb-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder mt-1 mb-1 fs-2">{{ __('My profile')}}
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0" style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">{{__('Change profile')}}</h3>
											</div>
											<!--end::Card title-->
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('monprofil.update', $monprofil->id)}}">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('First name')}} :</label>
                                                <input type="text" name="prenom" value="{{$monprofil->prenom}}" class="form-control form-control-solid" placeholder="prenom"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Last name')}} :</label>
                                                <input type="text" name="nom" value="{{$monprofil->nom}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('E-mail')}} :</label>
                                                <input type="email" name="email" value="{{$monprofil->email}}" class="form-control form-control-solid" placeholder="axel.n@illimitis.com"/>
                                            </div>
                                             <?php
                                                $participant = DB::table('participants')->where('user_id', Auth::id())->first();
                                            ?>
                                            @if($participant)
                                            <div class="mb-10">
                                              <label for="exampleFormControlInput1" class=" form-label">{{__('Function')}} :</label>
                                                <input type="text" name="fonction" value="{{$participant->fonction}}" class="form-control form-control-solid" placeholder="Fonction"/>
                                            </div>
                                            @else
                                            <div class="mb-10">
                                              <label for="exampleFormControlInput1" class=" form-label">{{__('Function')}} :</label>
                                                <input type="text" name="fonction"  class="form-control form-control-solid" placeholder="Fonction"/>
                                            </div>
                                            @endif
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Phone number')}} :</label>
                                                <input type="text" name="portable" value="{{$monprofil->portable}}" class="form-control form-control-solid" placeholder="00221 782967825"/>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">{{__('Upload a profile picture in square format (150px * 150px)')}}</label>
                                                <input class="form-control" name="photo" value="{{$monprofil->photo}}" type="file" id="formFile">
                                            </div>
                                            
                                            <!--<div class="mb-10">-->
                                            <!--    <span class="form-label">{{__('Choose the langage system')}} :</label><br><br>-->
                                            <!--    @foreach($langages as $langage)-->
                                            <!--        <label for="exampleFormControlInput2" class="form-label">{{$langage->libelle_eng}}-->
                                            <!--            <input class="form-control form-control-solid" type="radio" id="exampleFormControlInput2" name="langage_system" value="{{$langage->id}}" @if($langage->id == $monprofil->langue_id) checked @endif>-->
                                            <!--        </label><br>-->
                                            <!--    @endforeach-->
                                            <!--    </select>-->
                                            <!--</div>-->
                                            ...
                                            <!--    <input type="password" name="password" value="" class="form-control form-control-solid" />-->
                                            <!--</div>-->
                                            <!--<div class="mb-10">-->
                                            <!--    <label for="exampleFormControlInput1" class="required form-label">Confirmer le mot de passe :</label>-->
                                            <!--    <input type="password" name="password_confirmation" value="" class="form-control form-control-solid" />-->
                                            <!--</div>-->
                                            <button class="btn btn-orange" type="submit"> {{__('Approve')}}</button>
                                            <a href="/monprofils"><button type="button" class="btn btn-danger"style="background:#C92C2B;color:white"> {{__('Quit')}}</button></a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
							...
							<div class="timeline-item">
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="pe-3 mb-5">
										...
										<a href="#" class="text-primary fw-bolder me-1">#67890</a>is assigned to you in Multi-plat<formm Database Design project</div>
										<!--end::Title-->
										<!--begin::Description-->
										<div class="overflow-auto pb-5">
											<!--begin::Wrapper-->
