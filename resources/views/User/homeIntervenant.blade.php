							...
							<!--begin::Layout - Overview-->
									...
									<div class="row">
                                        <div class="col-12 grid-margin">
                                          <div class="card">
                                            <div class="card-body">
                                            <h3 class="card-title" >{{ __('The activities on which I intervene') }} </h3><br>
                                                ...
                                                @foreach($interventions as $intervention)
                                                    <tr>
                                                      ...
                                                      <td class="text-center"> 
                                                         <a href="{{$intervention->join_url}}" class="btn  btn-sm"style="background:#4B0082;color:white">Join</a>
                                                      </td>
                                                    </tr>
                                                @endforeach    
                                                  </tbody>
                                    ...
                                    <div class="row mt-10">
                                        <div class="col-12 grid-margin">
                                          <div class="card">
                                            <div class="card-body">
                                            <h3 class="card-title" >{{ __('Global calendar of activities') }}</h3><br>
