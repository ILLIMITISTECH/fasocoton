									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0">{{ __('Change the participant')}}</h3>
											</div>
											<!--end::Card title-->
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('membre.update', $membre->id)}}">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('First name')}} :</label>
                                                <input type="text" name="prenom" value="{{$membre->prenom}}" class="form-control form-control-solid" placeholder="prenom"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Last name')}} :</label>
                                                <input type="text" name="nom" value="{{$membre->nom}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('E-mail')}} :</label>
                                                <input type="email" name="email" value="{{$membre->email}}" class="form-control form-control-solid" placeholder="axel.n@illimitis.com"/>
                                            </div>
                                            <br>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Phone number')}} :</label>
                                                <input type="text" name="tel_part" value="{{$membre->tel_part}}" class="form-control form-control-solid" placeholder="axel.n@illimitis.com"/>
                                            </div>
                                            <br>
                                             <div class="form-group">
                                                   <label for="website">{{__('Country')}}  </label>
                                                <select class="form-select" name="pays_id" id="stade_entreprise">
                                                    <?php
                                                    $payss = DB::table('pays')->where('id', $membre->pays_id)->first();
                                                    ?>
                                                  <option value="{{$membre->pays_id}}">{{$payss->libelle_fr}}</option>
                                                        @foreach($pay as $pays)  
                                                        <option value="{{$pays->id}}">{{$pays->libelle_fr}}</option>
                                                        @endforeach
                                                </select>     
                                              </div>
                                            <hr>
                                            ...
                                            <!--</div>-->
                                            <button class="btn btn-violet" type="submit"> {{__('Approve')}}</button>
                                            <a href="/madelegations"><button type="button" class="btn btn-danger"> {{__('Quit')}}</button></a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
