							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-6" id="kt_profile_details_view">
										<!--begin::Card header-->
										<div class="card-header cursor-pointer" style="position : relative; margin-top : 1%; margin-bottom : 1%;">
											<!--begin::Card title-->
											<div class="card-title m-0" >
												<h3 class="fw-bolder m-0">Mon Badge / My Pass </h3>
													<a href="{{ URL::to('/user/pdf') }}" class="btn btn-violet" style="position :absolute; right :5%;"><span class="menu-title">Imprimer mon Badge</span></a>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<div class="card-body p-9">
											...
											<label class="col-lg-4 fw-bold">Mon code participant : 
												<div class="fs-6 fw-bold mb-8" style="margin-top:20px;">
												    ...
												    @endphp
												    <center>
												      {{ \QrCode::size(250)->generate('https://optieventdemo.mobiagri.com/qrcode_parse/'.$data); }}
												    </center>
