@include('User/head')
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed">
						...
						<div class="menu menu-column menu-pill menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-arrow-gray-500 menu-active-bg-primary fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
							<div class="hover-scroll-y me-n3 pe-3" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="20px">
								<div class="menu-item mb-1">
									<a class="menu-link active" href="/madelegations">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
								    <a href="/membre_ajouter"  aria-controls="mon_profil">
									<span class="menu-link">
										...
										<span class="menu-title">{{ __('Add Members') }}</span>  
        ...
        <!--                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">-->
        <!--                            	<a href="/entrepriseajoutD"  aria-controls="mon_profil">-->
        <!--									<span class="menu-link">-->
        <!--										<span class="menu-icon">-->
        ...
        <!--                                              </svg>-->
        											<!--end::Svg Icon-->
        <!--			</span>-->
        <!--										<span class="menu-title">{{ __('Add companies') }}</span> -->
    				<!--						</span>-->
								<!--		</a>-->
								<!--</div>	-->
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
								    <a href="/badge_deleguer"  aria-controls="mon_profil">
									<span class="menu-link">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    									    ...
    									    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                                  <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                     ...
                                                     <div class="carousel-item active">
                                                        <img class="pub-image" src="{{asset('User/assets/media/{{asset('sbpme/logo-salon-9em.png')}}.png')}}">
                                                    </div>
                                                     <div class="carousel-item active">
                                                        <img class="pub-image" src="{{asset('User/assets/media/{{asset('sbpme/logo-salon-9em.png')}}.png')}}">
                                                    </div>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 mb-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder mt-1 mb-1 fs-2">{{ __('My Delegation') }}
         ...
         <!--           </h6>-->
					 ...
					 <!--========================= Menu Hamburger   =========================-->
							...
							<div class="d-flex d-lg-none align-items-center flex-grow-1">
								...
								<div class="btn btn-icon btn-circle btn-active-light-primary ms-n2 me-1" id="kt_aside_toggle">
									<!--begin::Svg Icon | path: icons/duotone/Text/Menu.svg-->
									<span class="svg-icon svg-icon-2x">ct x="0" y="0" width="24" height="24" />
												<rect fill="#000000" x="4" y="5" width="16" height="3" rx="1.5" />
												<pa
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<reth d="M5.5,15 L18.5,15 C19.3284271,15 20,15.6715729 20,16.5 C20,17.3284271 19.3284271,18 18.5,18 L5.5,18 C4.67157288,18 4,17.3284271 4,16.5 C4,15.6715729 4.67157288,15 5.5,15 Z M5.5,10 L18.5,10 C19.3284271,10 20,10.6715729 20,11.5 C20,12.3284271 19.3284271,13 18.5,13 L5.5,13 C4.67157288,13 4,12.3284271 4,11.5 C4,10.6715729 4.67157288,10 5.5,10 Z" fill="#000000" opacity="0.3" />
											</g>
										</svg>
									</span>
									<!--end::Svg Icon-->
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
        								...
        								<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        									...
        									<div class="cursor-pointer symbol symbol-circle symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
													<img alt="Pic" src="{{url('imags', $delegations->photo)}}" />
        									</div>
        									<!--begin::Menu-->
        									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
        										...
        										<!--	<a href="/monprofils" class="menu-link px-5">Mon Profile</a>-->
        										<!--</div>-->
        										<!--end::Menu item-->
                                                <!--begin::Menu item-->
        										<!--<div class="menu-item px-5">-->
        										<!--	<a href="/monentreprises" class="menu-link px-5">Mon Entreprise</a>-->
        										<!--</div>-->
        										<!--end::Menu item-->
        										<!--begin::Menu item-->
        										<div class="menu-item px-5">
            											<a href="{{route('setting.edits', Auth::user()->id)}}" class="menu-link px-5">{{ __('My Settings') }}</a>
        										</div>
        										<!--end::Menu item-->
										...
										<div class="card-body pt-0 p-10">
											...
											<div class="d-flex flex-center flex-column mb-10">
												...
												<a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bolder mb-1">
												    @if($delegations)
												    {{$delegations->prenom}} {{$delegations->nom}}
												    @else
												    <p></p>
												    @endif
												    </a>
												<!--end::Name-->
												<!--begin::Position-->
												<!--<div class="fs-6 fw-bold text-gray-400 mb-2">Chef de projets Digitaux</div>-->
												<!--end::Position-->
											
											</div>
											<!--end::Summary-->
											<div class="center-buttons">
												<a href="{{route('delegation.edit', $delegations->id)}}" type="button" class="btn btn-violet">{{ __('change profile') }} </a>
												<!--<a href="#" type="button" class="btn btn-orange">Voir mon Entreprise </a>-->
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<!--begin::Card body-->
											...
											<!--		<span class="fw-bold fs-6">ILLIMTIS</span>-->
											<!--	</div>-->
												<!--end::Col-->
											<!--</div>-->
											<!--end::Input group-->
									...
									<div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0">{{ __('Company of my delegation') }}</h3>
											</div>
                                    ...
                                    <a href="{{route('entrepriseD.edite', $entreprises->id)}}">
                                <button type="button" class="btn  btn-sm"style="background:#23B40B;color:white"><i class="bi bi-pen-fill"></i></i></button>
                            </a>
                                            <form action="{{route('entrepriseD.destroye', $entreprises->id)}}" method="post">
                                                  {{ csrf_field() }}
                                                  @method('DELETE')
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0">{{ __('Participants Company of my delegation') }}</h3>
                                            ...
                                            <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
                                                ...
                                                <tbody>
    												...
    												<td>
                                                        ...
                                                        <td>
                                                            <div class="options-td">
                                                                <!--<button class="btn btn-violet" data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier"><i class="las la-edit"  style="color :white;"></i></button>-->
                                                                <!--<button class="btn btn-orange" data-bs-toggle="tooltip" data-bs-placement="top" title="Détails du participant"><i class="las la-info-circle" style="color :white;"></i></button>-->
                                                                <!--<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Supprimer"><i class="las la-trash" style="color :white;"></i></button>-->
                                                             <a href="{{route('monparticipant.edit', $participant->id)}}">
                                <button type="button" class="btn  btn-sm"style="background:#23B40B;color:white"><i class="bi bi-pen-fill"></i></i></button>
                            </a>
                                            <form action="{{route('monparticipant.destroy', $participant->id)}}" method="post">
                                                  {{ csrf_field() }}
                                                  @method('DELETE')
                                            <button type="submit" class="btn  btn-sm"style="background:#C92C2B;color:white"><i class="bi bi-trash-fill"></i></button>  
                                            </form> 
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0">Participants sans Entreprise de ma délégation</h3>
											</div>
                                            ...
                                            <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>@if($membre)
    												    ...
    												    <?php
    												        $pay = DB::table('pays')->where('id', $membre->pays_id)->first();
    												    ?>
    												     <td>@if($pay)
        												    {{$pay->libelle_fr}}
        												    @else
                                                        ...
                                                        <td>
                                                            <div class="options-td">
                                                                ...
                                                                <!--<button class="btn btn-orange" data-bs-toggle="tooltip" data-bs-placement="top" title="Détails du participant"><i class="las la-info-circle" style="color :white;"></i></button>-->
                                                                <!--<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Supprimer"><i class="las la-trash" style="color :white;"></i></button>-->
                                                             <a href="{{route('membre.edit', $membre->id)}}">
                                <button type="button" class="btn  btn-sm"style="background:#23B40B;color:white"><i class="bi bi-pen-fill"></i></i></button>
                            </a>
