						...
						<div class="container" id="kt_content_container">
							...
							<div class="card bg-dark">
								...
								<div class="card-body p-lg-20">
									...
									<div class="mb-5">
										<!--begin::Title-->
										<h1 class="fs-2x text-light w-bolder mb-6">Bienvenue Fallou !</h1>
										<!--end::Title-->
										<!--begin::Text-->
										<p class="fw-bold text-light fs-4 mb-2">
                                            La phase d’inscription du Rebranding Africa Forum est toujours en cours. Elle prendra fin le <span class="text-primary">20 Septembre</span>. 
                                            Le comité d’organisation t’invite à completer entièrement ton profil, à ajouter les informations de <span class="text-primary">ton entreprise (Optionnel) </span>et à règler tes <span class="text-primary">frais de participation si ce n’est pas encore fait !</span>
                                        </p>
						...
						<div class="container mt-10" id="kt_content_container">
							...
							<div class="card">
								...
								<div class="card-body p-lg-20">
									...
									<div class="mb-5">
										<!--begin::Title-->
										<h3 class="fs-1x mb-6"> <i class="bi bi-exclamation-circle" style="font-size: 1.5rem; color: orange;"></i> Fallou , ton compte n’est pas actif !</h3>
										<!--end::Title-->
										<!--begin::Text-->
										<p class="fw-bold fs-4  mb-2">
                                            Le comité d’organisation t’invite à régler tes modalités de participation pour activer ton compte et participeraux différentes activités de l'évènemnent.
                                        </p>
										<!--end::Text-->
									</div>
                                    <button type="button" class="btn btn-primary">J’active mon Compte</button>
