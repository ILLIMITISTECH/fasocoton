							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('settings.update', $monprofil->id)}}">
                                                {{ csrf_field() }}
                                            ...
                                            <button class="btn btn-violet" type="submit"> Valider</button>
