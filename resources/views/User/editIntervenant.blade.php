						...
						<div class="menu menu-column menu-pill menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-arrow-gray-500 menu-active-bg-primary fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
							<div class="hover-scroll-y me-n3 pe-3" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="20px">
								<div class="menu-item mb-1">
									<a class="menu-link active" href="/homeintervenants">
                                    	...
                                    	<a href="/homeintervenants"  aria-controls="mon_profil">
							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('intervenant.update', $intervenant->id)}}">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('First name')}} :</label>
                                                <input type="text" name="prenom" value="{{$intervenant->prenom}}" class="form-control form-control-solid" placeholder="prenom"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Last name')}} :</label>
                                                <input type="text" name="nom" value="{{$intervenant->nom}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <input type="text" name="portable" value="{{$intervenant->portable}}" class="form-control form-control-solid" placeholder="00221 782967825"/>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">{{__('Upload a profile picture in square format (150px * 150px)')}}</label>
                                                <input class="form-control" name="photo" value="{{$intervenant->photo}}" type="file" id="formFile">
                                            </div>
                                            <br>
                                            <hr>
