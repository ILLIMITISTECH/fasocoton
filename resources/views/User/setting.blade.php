									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0">Modifier le Mot de passe</h3>
											</div>
											<!--end::Card title-->
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('setting.updat', $delegations->id)}}">
                                                {{ csrf_field() }}
                                            ...
                                            <a class="btn btn-danger" href="/madelegations" > Quitter</a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
