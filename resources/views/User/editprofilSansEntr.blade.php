                                	...
                                	<!--<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                    	...
                                    	<a href="#"  aria-controls="mon_profil" data-toggle="tooltip" data-placement="top" title="Votre badge sera bientot disponible !">
        									<span class="menu-link"  style="color:#D0D0D0">
        										...
        										<span class="menu-title" style="color:#D0D0D0">{{__('My Badge')}}</span> 
    										</span>
										</a>
								    </div>-->
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0">{{__('Change profile')}}</h3>
											</div>
											<!--end::Card title-->
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('pSansEntr.updates', $profilsansentr->id)}}">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('First name')}} :</label>
                                                <input type="text" name="prenom" value="{{$profilsansentr->prenom}}" class="form-control form-control-solid" placeholder="prenom"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Last name')}} :</label>
                                                <input type="text" name="nom" value="{{$profilsansentr->nom}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('E-mail')}} :</label>
                                                <input type="email" name="email" value="{{$profilsansentr->email}}" class="form-control form-control-solid" placeholder="axel.n@illimitis.com"/>
                                            </div>
                                             <?php
                                            ...
                                            <div class="mb-10">
                                              <label for="exampleFormControlInput1" class=" form-label">{{__('Function')}} :</label>
                                                <input type="text" name="fonction" value="{{$profilsansentr->fonction}}" class="form-control form-control-solid" placeholder="Fonction"/>
                                            </div>
                                            @else
                                            <div class="mb-10">
                                              <label for="exampleFormControlInput1" class=" form-label">{{__('Function')}} :</label>
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <input type="text" name="portable" value="{{$profilsansentr->portable}}" class="form-control form-control-solid" placeholder="00221 782967825"/>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">{{__('Upload a profile picture in square format (150px * 150px)')}} </label>
                                                <input class="form-control" name="photo" value="{{$profilsansentr->photo}}" type="file" id="formFile">
                                            </div>
                                            <br>
                                            <hr>
                                            ...
                                            <a href="/myprofil"><button type="button" class="btn btn-danger"style="background:#C92C2B;color:white">  {{__('Quit')}}</button></a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
