										...
										<div class="card-body pt-0 p-10">
											...
											<div class="d-flex flex-center flex-column mb-10">
												...
												<div class="symbol mb-3 symbol-100px symbol-circle">
													<img alt="Pic" src="{{url('photos', $entreprise->photos)}}"/>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
												<a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bolder mb-1"> @if($entreprise)
												...
												<!--end::Name-->
												<!--begin::Position-->
												<div class="fs-6 fw-bold text-gray-400 mb-2"> @if($entreprise)
												    {{$entreprise->slogan}}
												    @else
												    <p></p>
												    @endif</div>
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">Details  l'Entreprise</h3>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												...
												<div class="col-lg-8 d-flex align-items-center">
													<span class="fw-bolder fs-6 me-2"> @if($entreprise)
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">Centres d'intérêts </h3>
											</div>
