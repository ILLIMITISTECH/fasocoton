							...
							<div class="card">
                                <div class="card-header">
                                    ...
                                    <h4 class="mt-2">{{ __('My appointment wishes') }}</h4> 
                                     <br>
                                    <p class="texte-nice" style="position: absolute;top: 18%;">{{ __('Appointment that I requested while browsing the catalog') }}</p>
								...
								<div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table style ="width: 100%;" class="table table-hover table-striped border gy-7 gs-7">
                                            ...
                                            <!--                    {{ csrf_field() }}-->
                                            <!--                     <button type="submit" id="p1"  class="btn btn-danger">{{ __('Delete') }}</button>-->
                                            <!--                </form>-->
