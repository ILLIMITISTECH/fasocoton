									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0">{{__('Add members')}}</h3>
											</div>
											<!--end::Card title-->
										...
										<div class="card-body p-9">
										 <p class="card-description">{{__('Fill out this form to add a participant')}}</p>
                                            <form class="forms-sample"  action="/membre_ajouter" method="post" enctype="multipart/form-data">
                                                  {{ csrf_field() }}
                                              <div class="form-group">
                                                <label for="exampleInputName1">{{__('Last name')}}  <span style="color:red">*</span></label>
                                                <input type="text" class="form-control" name="nom" id="exampleInputName1" placeholder="Name" requiered>
                                              </div><br>
                                              <div class="form-group">
                                                <label for="website">{{__('First name')}} <span style="color:red">*</span></label>
                                                <input type="text" name="prenom" class="form-control" id="website" placeholder="prenom" requiered>
                                              </div><br>
                                              <div class="form-group">
                                                <label for="website">{{__('E-mail')}}</label>
                                                <input type="email" name="email" class="form-control" id="website" placeholder="example@..." >
                                              </div><br>
                                              <div class="form-group">
                                                <label for="website">{{__('Phone number')}} </label>
                                                <input type="text" name="tel_part" class="form-control" id="website" placeholder="téléphone..." >
                                              </div><br>
                                              <div class="form-group">
                                                   <label for="website">{{__('Country')}}  <span style="color:red">*</span></label>
                                              ...
                                              <!--<div class="form-group">-->
                                              <!--  <label for="website">Enterprise <span style="color:red">*</span></label>-->
                                              <!--  <select name="enterprise" class="form-control" id="website">-->
                                              <!--      @foreach($enterprises as $enterprise)-->
                                              <!--          <option value="{{$enterprise->id}}">{{$enterprise->nom_entreprise}}</option>-->
                                              <!--      @endforeach-->
                                              <!--  </select>-->
                                              <!--</div>-->
                                              <br><br>
                                            <button type="submit" class="btn mr-2"style="background:#F49800; color:white">{{__('Approve')}}</button>
                                            <a class="btn " style="background:#C92C2B; color:white" href="/madelegations">{{__('Quit')}}</a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
