@include('User/head')
							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										<!--begin::Card header-->
										<div class="card-header cursor-pointer"style="background:#F49800;width:400px;">
											<!--begin::Card title-->
												<div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="color:white;margin-left:30px;font-family:Lucida Console,Courier New,monospace;">{{__('Add more participants')}}</h3>
											</div>
											<!--end::Card title-->
										...
										<div class="card-body p-9">
										 <p class="card-description">{{__('Fill out this form to add a participant')}}</p>
                                            <form class="forms-sample"  action="/createparticipant" method="post" enctype="multipart/form-data">
                                                  {{ csrf_field() }}
                                              ...
                                              <div class="form-group">
                                                <label for="website">{{__('Phone')}}</label>
                                                <input type="text" name="tel_part" class="form-control" id="website" placeholder="phone">
                                              </div><br>
                                               <br>
                                              <div class="form-group">
                                                <label for="website">{{__('Function')}} </label>
                                                <input type="text" name="fonction" class="form-control" id="website" placeholder="fonction">
                                              </div><br>
                                              <div class="form-group">
                                                  <p>{{__('Please fill in the correct email address so that the participant can print the badge himself. For all emails not filled in, the badges will have to be collected from the organizing committee')}}</p>
  ...
  @error('email')
                                ...
                                @enderror
                                            ...
                                            <a class="btn " style="background:#C92C2B; color:white" href="/monentreprises">{{__('Quit')}}</a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
