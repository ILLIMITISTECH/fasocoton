                        ...
                        <div class="container mt-3" id="kt_content_container">
                            ...
                            <div class="card">
                                <div class="card-body"> 
                                   ...
                                   <form action="/filtre_catalogues" method="get">
                                       {{csrf_field()}}
                                       <select name="filtre_catalogues_pays">
                                       ...
                                       <select name="filtre_catalogues_secteur">
                                           <?php $secteurs = DB::table('secteur_activites')->get(); ?>
                                       ...
                                       <select name="filtre_catalogues_profil">
                                           <?php $profils = DB::table('profils')->get(); ?>
                                           <option value="">{{__('Select by pofile')}}</option>
                                           @foreach($profils as $profil)
                                           <option value="{{$profil->libelle}}">{{$profil->libelle}}</option>
                                           @endforeach
                                       </select>
                                       
                                       <select name="filtre_catalogues_entreprise">
                                           <?php $entreprises = DB::table('entreprise_rvs')->get(); ?>
                                           <option value="">{{__('Select by profile')}}</option>
                                           @foreach($entreprises as $entreprise)
                                           <option value="{{$entreprise->nom_entreprise}}">{{$entreprise->nom_entreprise}}</option>
                                           @endforeach
                                       </select>
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <a href="{{route('home.catalogue_rvs')}}" style="padding:6px 5px; background:#480099; color:white " class="btn btn-default">Refresh ♻️</a><br><br>
        
                                    <input class="form-control" type="search" id="search_text" placeholder="Search by country, sectors, profiles or company name"> <br>
                                    <div class="tables">
                                        ...
                                        <table id="datatable-buttons" style ="width: 100%;" class="table table-hover table-striped border gy-7 gs-7">
                                            ...
                                            <tbody id="autocomplete">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#">{{$entreprise->pays}}</a></td>
                                                   ...
                                                   <!-- <td> <span class="badge badge-info">5</span></td> -->
                                                    ...
                                                    <td>
                                                        ...
                                                        <form method="POST" action="{{route('ajouter.suggestion_rvs', $entreprise->id)}}">
                                                            {{ csrf_field() }}
                                                              @if(in_array($entreprise->id, $input))
                                                                <input type="submit" id="p1" style="background: #7f8c8d; color:white" class="btn btn-default" value="Déjà Ajouté" disabled></button>
                                                              @else 
                                                                <input type="submit" id="p1" class="btn btn-primary" value="Ajouter"/>
                                                              @endif 
                                                        </form>
