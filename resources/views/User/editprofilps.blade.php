							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('profilps.update', $profilps->id)}}">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('First name')}} :</label>
                                                <input type="text" name="prenom" value="{{$profilps->prenom}}" class="form-control form-control-solid" placeholder="prenom"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Last name')}} :</label>
                                                <input type="text" name="nom" value="{{$profilps->nom}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('E-mail')}}  :</label>
                                                <input type="email" name="email" value="{{$profilps->email}}" class="form-control form-control-solid" placeholder="axel.n@illimitis.com"/>
                                            
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Phone number')}} :</label>
                                                <input type="text" name="portable" value="{{$profilps->portable}}" class="form-control form-control-solid" placeholder="00221 782967825"/>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">{{__('Upload a profile picture in square format (150px * 150px)')}} </label>
                                                <input class="form-control" name="photo" value="{{$profilps->photo}}" type="file" id="formFile">
                                            </div>
                                            <br>
                                            <hr>
                                            ...
                                            <a href="/monprofil"><button type="button" class="btn btn-danger"> {{__('Quit')}}</button></a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
