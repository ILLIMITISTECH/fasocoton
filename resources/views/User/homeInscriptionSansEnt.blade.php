        								...
        								<div class="card-body p-lg-20">
        									...
        									<div class="mb-5">
        										...
        										<p class="fw-bold text-light fs-4 mb-2">
                                                    <span class="text-light">{{ __('The SICOT 2024 registration phase is underway. It will close on January 16, 2024. The organizing committee invites you to complete your profile.') }}
