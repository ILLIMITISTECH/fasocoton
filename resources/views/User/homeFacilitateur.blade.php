				...
				<div id="kt_aside" class="aside bg-white" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-menu flex-column-fluid px-3 px-lg-6">
						...
						<div class="menu menu-column menu-pill menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-arrow-gray-500 menu-active-bg-primary fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
							<div class="hover-scroll-y me-n3 pe-3" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="20px">
								<div class="menu-item mb-1">
									<a class="menu-link active" href="/homefacilitateurs">
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                    	...
                                    	<a href="/badge_facilitateur"  aria-controls="mon_profil" data-toggle="tooltip" data-placement="top" title="Votre badge sera bientot disponible !">
						...
						<div class="container" id="kt_content_container">
							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-column flex-lg-row-auto w-100 w-xl-325px mb-10">
									<!--begin::Card-->
									<div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar" data-kt-sticky-offset="{default: false, xl: '80px'}">
										<!--begin::Card header-->
										...
										<div class="card-body pt-0 p-10">
											...
											<div class="center-buttons">
												<a href="{{route('intervenant.edit', Auth::user()->id)}}" type="button" class="btn btn-violet">{{ __('change profile') }} </a>
            				...
            				<div class="container" id="kt_content_container">
                                <div class="row">
                                        <div class="col-12 grid-margin">
                                          <div class="card">
                                            <div class="card-body">
                                            <h3 class="card-title" style="color:#FFA500">{{ __('Global calendar of activities') }}</h3><br>
                        
                                              <div class="table-responsive">
                                                <table class="display" style="width:100%">
                                                  <thead>
                                                        <tr class="fw-bolder m-0">
                                                          <th class="" style="width:60%"> {{ __('Label') }} </th>
                                                  ...
                                                  <tbody class="m-0">
                                                @foreach($activities as $intervention)
                                                    <tr>
                                                      <td class="">{{$intervention->libelle}}</td>
                                                      <td class="text-center">{{$intervention->heure_debut}} / {{$intervention->heure_fin}}</td>
                                                      <td class="text-center">{{$intervention->date}}</td>
                                                      <td class="text-center">{{$intervention->password}}</td>
