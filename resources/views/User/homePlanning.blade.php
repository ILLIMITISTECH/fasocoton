				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid fs-6" id="kt_content">
						...
						<div class="container" id="kt_content_container">
							...
							<div class="card bg-dark">
								...
								<div class="card-body p-lg-20">
									...
									<div class="mb-5">
										<!--begin::Title-->
										<h1 class="fs-2x text-light w-bolder mb-6">Bienvenue {{Auth::user()->prenom}} !</h1>
										<!--end::Title-->
										<!--begin::Text-->
										<p class=" text-light fw-bold fs-4 mb-2">
                                            Nous sommes à la dernière ligne droite avant le début du Rebranding Africa Forum ! <br>
                                            Ton <span class="text-primary">planning d'activités</span> est disponible.                                 
                                         </p>
										<!--end::Text-->
									</div>
						...
						<div class="container mt-10" id="kt_content_container">
							...
							<div class="card">
                                <div class="card-header">
                                    <h4 class="mt-2">Mes activités à venir </h4>
                                </div>
								<!--begin::Card body-->
								<div class="card-body">
                                        ...
                                        <table style ="width: 100%;" class="table table-hover table-striped border gy-7 gs-7">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Mardi 18 Octobre</td>
                                                    <td>12h00 - 15h 00 GMT</td>
                                                    <td>Sallle Nelson Mandela</td>
                                                    <td><button class="btn btn-primary">Rejoindre</button></td>
                        ...
                        <div class="container mt-10" id="kt_content_container">
							...
							<div class="card">
                                <div class="card-header">
                                    <h4 class="mt-2">Mes Rendez-vous à venir  </h4>
                                </div>
								<!--begin::Card body-->
								<div class="card-body">
                                    <div class="table-responsive">
                                        <table style ="width: 100%;" class="table table-hover table-striped border gy-7 gs-7">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Mardi 18 Octobre</td>
                                                    <td>12h00 - 15h 00 GMT</td>
                                                    <td>Sallle 1 - Table 2</td>
                                                    <td class="options-td"> 
                                                        <button class="btn btn-primary disabled">Rejoindre</button>
                                                        <div class="dropdown">
                                                            <button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                                              Options
                                                            </button>
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                              <li><a class="dropdown-item" href="#">Annuler le Rdv</a></li>
                                                              <li><a class="dropdown-item" href="#">Participer en ligne</a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="options-td"> 
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                              <li><a class="dropdown-item" href="#">Annuler le Rdv</a></li>
                                                              <li><a class="dropdown-item disabled" href="#">Participer en ligne</a></li>
                                                              <li><a class="dropdown-item" href="#">Message</a></li>
                                                            </ul>
                                                          </div>
                                                    </td>
