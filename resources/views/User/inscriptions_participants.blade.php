    ...
    @include('User/sideInscription')
                <div class="col-6 left-part">
                    ...
                    <div class="form-part" style ="margin-top : -5%;">
                       <form action="/inscriptions_participants"  method=post>
                       {{ csrf_field() }}
                        <div class="mb-7">
                        ...
                        <div class="mb-7">
                            ...
                            <input id="email-confirm" placeholder="Entrer l'adresse mail"/ type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email">
              ...
              <!---<input type="hidden" name="password" class="form-control" value="123456" placeholder="Mot de passe"/>-->
                      <div class="mb-7">
                            <label for="exampleFormControlInput1" class="form-label">{{ __('Entreprise') }}: </label>
                            <input type="text" class="form-control @error('structure') is-invalid @enderror" name="structure" value="{{ old('structure') }}" autocomplete="nom" placeholder="Entrer le nom"/>
                        </div>
                         <div class="mb-7">
                            <label for="exampleFormControlInput1" class="form-label">{{ __('Function') }}: </label>
                            <input type="text" class="form-control @error('fonction') is-invalid @enderror" name="fonction" value="{{ old('fonction') }}" autocomplete="nom" placeholder="Entrer le nom"/>
                        </div>
                        <div class="mb-7">
