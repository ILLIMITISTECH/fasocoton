                        ...
                        <div class="container mt-3" id="kt_content_container">
							...
							<div class="card">
                                <div class="card-header">
                                    <h4 class="mt-2">{{ __('My automatic appointment suggestions (to Accept or Decline)') }}:</h4>
                                    <br>
                                    <p class="texte-nice">{{ __('Appointment suggestions generated by the system based on your interests') }} </p>
                                </div>
								<!--begin::Card body-->
								<div class="card-body">
                                    <div class="table-responsive">
                                        <table style ="width: 100%;" class="table table-hover table-striped border gy-7 gs-7">
                                            ...
                                            <tbody>
                                            <?php $souh = DB::table('souhaits_rvs')->where('user_id', Auth::id())->get()?>
                                              @foreach($souh as $souhait)
                                                <tr>
                                                   ...
                                                   <!-- @foreach($users as $user)
                                                    ...
                                                    <?php $participant = DB::table('participants')->where('entreprise_id', '=', $entreprise->id)->first() ?>
                                                     <td>{{ ($participant) ? $participant->fonction : '--'}}</td>
                                                    <td><a href="#">{{ ($entreprise) ? $entreprise->nom_entreprise : '--'}}</a></td>
                                                   ...
                                                   @endif
                                                    ...
                                                    <td>
                                                        <div class="options-td">
                                                            <form method="POST" action="{{route('valider.souhait_rvs', $souhait->id)}}">
                                                              {{ csrf_field() }}
                                                            ...
                                                            <form method="POST" action="{{route('refuser.souhait_rvs', $souhait->id)}}">
                                                                {{ csrf_field() }}
                                                                <input type="submit" id="p1" class="btn btn-primary" value="Refuser"/>
                                                            </form>
						...
						<div class="container mt-5" id="kt_content_container">
							...
							<div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="texte-nice">{{ __('Appointment that I requested while browsing the catalog') }}</p>
                                    ...
                                    <div class="table-responsive">
                                        <table style ="width: 100%;" class="table table-hover table-striped border gy-7 gs-7">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $souh = DB::table('souhaites_rvs')->where('user_id', Auth::id())->get()?>
                                                 @foreach($souh as $souhait)
                                                <tr>
                                                   ...
                                                   <?php $user = DB::table('users')->where('id', $entreprise->user_id)->first() ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td><a href="#">{{$entreprise->nom_entreprise ? $entreprise->nom_entreprise : "~ ~" }}</a></td>
                                                   ...
                                                   @endif
                                                    ...
                                                    <td>
                                                      <div class="options-td">
                                                                  ...
                                                                  <form action="{{ route('destroySouhait.destroy_rvs',$souhait->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
							...
							<div class="card">
                                <div class="card-header">
                                    <h4 class="mt-2">{{ __('My appointment requests') }} </h4>
                                     <p class="texte-nice">{{ __('Appointment or I have been requested, waiting for my confirmation') }}</p>
                                        ...
                                        <table style ="width: 100%;" class="table table-hover table-striped border gy-7 gs-7">
                                            ...
                                            <tbody>
                                                <?php $entrepri = DB::table('entreprise_rvs')->where('user_id', '=', Auth::user()->id)->first() ?>
                                                  <?php $souh = DB::table('souhaites_rvs')->where('entreprise_rv_id', $entrepri->id)->get()?>
                                                 @foreach($souh as $souhait)
                                                <tr>
                                                  ...
                                                  @if($souhait->etats == 0)
                                                   ...
                                                   @endif
                                                    ...
                                                    <td>
                                                        <div class="options-td">
                                                              <form method="POST" action="{{route('etats.validers_rvs', $souhait->id)}}">
                                                            {{ csrf_field() }}
                                                             <button type="submit" id="p1"  class="btn btn-primary">{{ __('Confirm') }}</button>
                                                            </form>
                                                             <form method="POST" action="{{route('nons.validers_rvs', $souhait->id)}}">
                                                                {{ csrf_field() }}
                                              ...
                                              <?php $entrepri = DB::table('entreprise_rvs')->where('user_id', '=', Auth::user()->id)->first() ?>
                                            <?php $souh = DB::table('souhaits_rvs')->where('status', '=', 1)->where('priorite', '=', 0)->where('entreprise_rv_id', $entrepri->id)->get()?>
                                              @foreach($souh as $souhait)
                                                <tr>
                                                    ...
                                                    @foreach($users as $user)
                                                    <td><a href="#">{{$user->prenom}} {{$user->nom}}</a></td>
                                                   ...
                                                   @else
                                                    <td>
                                                       <span class="badge badge-primary">{{ __('Confirm') }}</span> 
                                                    </td>
                                                   @endif
                                                    <td>
                                                        <div class="options-td">
                                                              <form method="POST" action="{{route('etat.valider_rvs', $souhait->id)}}">
                                                            {{ csrf_field() }}
                                                             <button type="submit" id="p1"  class="btn btn-primary">{{ __('Confirm') }}</button>
                                                            </form>
                                                             <form method="POST" action="{{route('non.valider_rvs', $souhait->id)}}">
                                                                {{ csrf_field() }}
                                                                 <button type="submit" id="p1"  class="btn btn-danger">{{ __('Decline') }}</button>
                                                            </form>
