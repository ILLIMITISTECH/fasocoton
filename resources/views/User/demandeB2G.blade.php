        								...
        								<div class="card-body p-lg-20">
        									...
        									<div class="mb-5">
        										...
        										<p class="fw-bold text-light fs-4 mb-2">
                                                    <span class="text-light">{{ __('The SBPME organizers are giving you the opportunity to meet with officials from the Government of Burkina Faso during the next edition. In order to facilitate this meeting, please describe your needs and challenges, and the Organizing Committee will put you in touch with the following resource persons.') }} </span>
						...
						<div class="container" id="kt_content_container">
							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									<!--begin::details View-->
									<div class="card mt-5 mb-5 mb-xl-8" id="kt_profile_details_view">
										<!--begin::Card header-->
										<div class="card-header cursor-pointer">
											<!--begin::Card title-->
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0" style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">{{__('Other details about the people you want to meet')}}</h3>
											</div>
											<!--end::Card title-->
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="/mademandeb2g">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label"><b style="color:red">*</b>{{__('Needs / Challenges')}} 1:</label>
                                                <input type="text" name="difficulte1"  class="form-control form-control-solid" required/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Needs / Challenges')}} 2:</label>
                                                <input type="text" name="difficulte2"  class="form-control form-control-solid"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Needs / Challenges')}} 3:</label>
                                                <input type="text" name="difficulte3"  class="form-control form-control-solid" />
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('How do you think the government could help you?')}} :</label>
                                                <input type="text" name="aide"  class="form-control form-control-solid"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label"><b style="color:red">*</b>{{__('Identity of the people you want to meet')}} :</label>
                                                <input type="text" name="details"  class="form-control form-control-solid" required/>
                                            </div>
                                            <hr>

            
                                            <button class="btn btn-orange" type="submit"> {{__('Approve')}}</button>
                                            <a href="/home"><button type="button" class="btn btn-danger"style="background:#C92C2B;color:white"> {{__('Quit')}}</button></a>
                                            </form>
										</div>
										<!--end::Card body-->
									</div>
