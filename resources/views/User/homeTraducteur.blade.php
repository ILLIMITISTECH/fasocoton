				...
				<div id="kt_aside" class="aside bg-white" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-menu flex-column-fluid px-3 px-lg-6">
						...
						<div class="menu menu-column menu-pill menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-arrow-gray-500 menu-active-bg-primary fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
							<div class="hover-scroll-y me-n3 pe-3" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="20px">
								<div class="menu-item mb-1">
									<a class="menu-link active" href="/hometraducteurs">
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                    	...
                                    	<a href="badge_traducteur"  aria-controls="mon_profil" data-toggle="tooltip" data-placement="top" title="Votre badge sera bientot disponible !">
									...
									<div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar" data-kt-sticky-offset="{default: false, xl: '80px'}" data-kt-sticky-width="{lg: '250px', xl: '325px'}" data-kt-sticky-left="auto" data-kt-sticky-top="90px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
										...
										<div class="card-body pt-0 p-10">
											...
											<div class="d-flex flex-center flex-column mb-10">
												...
												<!--end::Avatar-->
												<!--begin::Name-->
												<a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bolder mb-1">{{ucfirst(Auth::user()->prenom)}} {{ucfirst(Auth::user()->nom)}}</a>
												<!--end::Name-->
												<!--begin::Position-->
											...
											<div class="center-buttons">
												<a href="{{route('traducteur.edit', Auth::user()->id)}}" type="button" class="btn btn-violet">{{ __('change profile') }} </a>
												<!--<a href="/monentreprises" type="button" class="btn btn-orange">Voir mon Entreprise </a>-->
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">{{ __('First name') }} :</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">{{ __('Last name') }} : </label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">{{ __('Phone') }} :
												</label>
												<!--end::Label-->
												<!--begin::Col-->
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">{{ __('Language') }} : </label>
												
												<!--end::Label-->
												<!--begin::Col-->
												@foreach ($traducteurs as $traducteur)
												<div class="col-lg-8 d-flex align-items-center">
                								<?php $langue = DB::table('langues')->where('id', $traducteur->langue_id)->first(); ?>
                								  @endforeach
                                                @if($langue)
                                                <div class="col-lg-8 d-flex align-items-center">
                                              <span class="fw-bolder fs-6 me-2">{{$langue->libelle_eng}} </span>
                                              	</div>
                                                @else
                                                <td>---</td>
                                                @endif
                                            ...
                                            <div class="card-body">
                                              <div class="table-responsive">
                                                <table class="display" style="width:100%">
                                                  <thead>
                                                    <tr class="fw-bolder m-0">
                                                      
                                                     <th class="col-lg-6"> {{ __('Label') }} </th>
                                                          <th class="text-center"> {{ __('Hour') }}</th>
                                                          <th class="text-center"> {{ __('Date') }}</th>
                                                          <th class="text-center"> {{ __('Code') }}</th>
                                                          <th class="text-center"> {{ __('Zoom link') }} </th>
                                                    </tr>
                                                  </thead>
                                                  <tbody class="m-0">
                                                    @foreach($interventions as $intervention)
                                                    <tr>
                                                      <td class="">{{$intervention->libelle}}</td>
                                                      <td class="">{{$intervention->heure_debut}} / {{$intervention->heure_fin}}</td>
                                                      <td class="">{{$intervention->date}}</td>
                                                      <td class="">{{$intervention->password}}</td>
                                                     <td class=""> 
                                                         <a href="{{$intervention->join_url}}" class="btn  btn-sm"style="background:#0D71EB;color:white">Join</a>
                                                      </td>
                                                      @endforeach
                      ...
                      <div class="table-responsive">
                        <table class="display" style="width:100%">
                          ...
                          <tbody class="">
                            ...
                            <tr>
                              <?php 
                                $entreprises = DB::table('entreprises')->where('id', '=', $planings->entreprise_id)->paginate(1);
                                $entreprise_rvs = DB::table('entreprise_rvs')->where('id', '=', $planings->entreprise_rv_id)->paginate(1);
                                $salle = DB::table('salles')->where('id', '=', $planings->sale_id)->paginate(1);
                                ?>
                                <td class=""><br>
                              ...
                              <td><br>
                               @foreach($entreprise_rvs as $entreprise_rv)
                              {{$entreprise_rv->nom_entreprise}}
                              @endforeach
                              </td>
                              <td class=""><br>
