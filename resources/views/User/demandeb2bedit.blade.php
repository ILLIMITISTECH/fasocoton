                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">Modifier les informations</h3>
											</div>
        
                                        </div>
                                        <div class="card-body">
                                            <form class="row g-3" action="{{route('mesdemandesb2bupdate', $entreprise->id)}}" method="post">
                            {{ csrf_field() }}
