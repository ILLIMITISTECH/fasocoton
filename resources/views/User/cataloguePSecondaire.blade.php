                    ...
                    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                        ...
                        <div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
                            ...
                            <div class="d-flex d-lg-none align-items-center flex-grow-1">
                                ...
                                <!--end::Aside Toggle-->
                                <!--begin::Logo-->
                                <a href="/connexions" class="d-lg-none">
                                    <img alt="Logo" src="{{asset('User/assets/media/logos/logo-compact.svg" class="max-h-40px')}}" />
                                </a>
                                <!--end::Logo-->
                            </div>
                            <!--end::Logo bar-->
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px symbol-circle me-5">
                                                    <img alt="Logo" src="{{asset('User/assets/media/avatars/150-1.jpg')}}" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="/monentreprises" class="menu-link px-5">{{__('Company')}}
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="/" class="menu-link px-5">{{__('Logout')}}</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
                            ...
                            <div class="card">
                                <div class="card-body"> 
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <h4 class="mb-2">{{__('List of companies registered for the Rebranding Africa Forum ')}}</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{route('home.catalogue')}}" style="padding:6px 5px; background:#480099; color:white " class="btn btn-default">{{__('Refresh')}} ♻️</a><br><br>
