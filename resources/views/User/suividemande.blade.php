					...
					<div class="content d-flex flex-column flex-column-fluid fs-6" id="kt_content">
						...
						<div class="container" id="kt_content_container">
							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<!--end::Sidebar-->
								<!--begin::Content-->
								<div class="flex-lg-row-fluid ms-lg-10 mt-5">
									<!--begin::details View-->
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										<!--begin::Card header-->
										<div class="card-header cursor-pointer"style="background:#390c6e;width:300px;">
											<!--begin::Card title-->
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="color:white;margin-left:30px;font-family:Lucida Console,Courier New,monospace;">{{ __('Status of the request')}}</h3>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<P>{{__('No request')}}</P>
										  ...
										  <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
										      <thead>
										          <tr>
										              <th>{{__('Needs / Challenges')}}</th>
										              <th>{{__('Identity of the people you want to meet')}}</th>
										              <th>{{ __('Status of the request')}}</th>
										          </tr>
										      </thead>
										      <tbody>
										          @foreach($demandeb2gs as $demandeb2g)
										          <tr>
										              <td> {{$demandeb2g->dificulte1}}</td>
										              <td> {{$demandeb2g->details}}</td>
										              @if($demandeb2g->statut == 0)
										              <td><span style="color:orange;">En attente</span></td>
										              @elseif($demandeb2g->statut == 1)
										              <td>{{ __('Status of the request')}} : <span style="color:green;">Validée</span></td>
										              @else
										              <td>{{ __('Status of the request')}} : <span style="color:red;">Refusée</span></td>
										              @endif
										          </tr>
										          @endforeach
										      </tbody>
