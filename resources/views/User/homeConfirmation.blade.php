						...
						<div class="container" id="kt_content_container">
							...
							<div class="card">
								...
								<div class="card-body p-lg-20">
									...
									<div class="mb-5">
										<!--begin::Title-->
										<h1 class="fs-2x w-bolder mb-6">Bienvenue Fallou !</h1>
										<!--end::Title-->
										<!--begin::Text-->
										<p class="fw-bold fs-4 mb-2">
                                            La phase de <b>confirmation de rendez-vous </b> du Rebranding Africa Forum est toujours en cours.
                                            <br>Elle prendra fin le <span class="text-primary">20 Septembre </span> .                                    
                                         </p>
                                         <p class="fw-bold fs-4 mb-2">
                                            Le comité d’organisation t’invite à  : 
                                            <ul>
                                                <li><span class="text-primary">Confirmer les rendez-vous </span> auxquels tu pourras participer</li>
                                                <li>Parcourir le catalogue des entreprises participantes et ajouter de nouveaux  <span class="text-primary">souhaits de rendez-vous</span> </li>
                                            </ul>
							...
							<div class="card">
								...
								<div class="card-body p-lg-20">
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td> <h4>Voir mes rendez-vous en attente de confirmation : </h4> </td>
                                            <td class="btn-td"><button type="button" class="btn btn-primary">Confirmation de rendez-vous</button></td>
                                        </tr>
                                        <tr>
