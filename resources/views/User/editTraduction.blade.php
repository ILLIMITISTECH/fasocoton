							...
							<div class="hover-scroll-y me-n3 pe-3" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="20px">
								<div class="menu-item mb-1">
									<a class="menu-link active" href="/homeintervenants">
                                    	...
                                    	<a href="/hometraducteurs"  aria-controls="mon_profil">
								         ...
								         <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                    	<a href="/badge_traducteur"  aria-controls="mon_profil">
        									<span class="menu-link">
        										<span class="menu-icon">
        											<!--begin::Svg Icon | path: icons/duotone/Interface/Lock.svg-->
        											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-briefcase-fill" viewBox="0 0 16 16">
							...
							<div class="d-flex flex-column flex-xl-row">
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-8" id="kt_profile_details_view">
										...
										<form id="demo1-upload" enctype="multipart/form-data" method="post" action="{{route('traducteur.update', $traducteur->id)}}">
                                                {{ csrf_field() }}
                                               
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('First name')}} :</label>
                                                <input type="text" name="prenom" value="{{$traducteur->prenom}}" class="form-control form-control-solid" placeholder="prenom"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Last name')}} :</label>
                                                <input type="text" name="nom" value="{{$traducteur->nom}}" class="form-control form-control-solid" placeholder="Nonguierma"/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('E-mail')} :</label>
                                                <input type="email" name="email" value="{{$traducteur->email}}" class="form-control form-control-solid" placeholder="axel.n@illimitis.com"/>
                                            </div>
                                          
                                            <div class="mb-10">
                                                <label for="exampleFormControlInput1" class=" form-label">{{__('Phone number')}} :</label>
                                                <input type="text" name="portable" value="{{$traducteur->portable}}" class="form-control form-control-solid" placeholder="00221 782967825"/>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">{{__('Upload a profile picture in square format (150px * 150px)')}} </label>
                                                <input class="form-control" name="photo" value="{{$traducteur->photo}}" type="file" id="formFile">
                                            </div>
                                            <br>
                                            <hr>
