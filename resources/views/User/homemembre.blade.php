									...
									<div class="card mb-5 mb-xl-6" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer" style="position : relative; margin-top : 1%; margin-bottom : 1%;">
											...
											<div class="card-title m-0" >
												<h3 class="fw-bolder m-0">{{ __('My badge') }} </h3>
												<a class="btn btn-violet" style="position :absolute; right :5%;">{{ __('Print my badge') }}</a>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold">{{ __('First name') }}:</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold ">{{ __('Last name') }}: </label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold">{{ __('Phone') }}:
												</label>
												<!--end::Label-->
												<!--begin::Col-->
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold">{{ __('Country') }}: 
											</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
											...
											<!--end::Input group-->
											<label class="col-lg-4 fw-bold">{{ __('My participating code :') }} 
