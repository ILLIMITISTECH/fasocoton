<div class="col-5 right-part">
    <div class="adspace-head mt-5">
        <div class="text-center">
            <img  class ="logo-client" src="{{asset('sicot/logo.jpeg')}}" alt="">
        </div>
        <div class="adspace-body col-4">
            <img class ="publicite" src="{{asset('sicot/image.jpeg')}}" alt="pub">
        ...
        <!--<div class="adspace-footer">
              <div class="row">
                <div class="col-4"><img class ="sponsors" src="{{asset('User/assets/media/logo-sponsors/LONAB.png')}}" alt="pub"></div>
                <div class="col-4"><img class ="sponsors" src="{{asset('User/assets/media/logo-sponsors/coris.png')}}" alt="pub"></div>
                <div class="col-4"><img class ="sponsors" src="{{asset('User/assets/media/logo-sponsors/Sonar.png')}}" alt="pub"></div>
            </div>
            <div class="row">
