		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 mb-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder mt-1 mb-1 fs-2">Mon Entreprise <br><br>
					...
					<div class="content d-flex flex-column flex-column-fluid fs-6" id="kt_content">
						...
						<div class="container" id="kt_content_container">
							...
							<div class="d-flex flex-column flex-xl-row">
										...
										<div class="card-body pt-0 p-10">
											...
											<div class="d-flex flex-center flex-column mb-10">
												...
												<div class="symbol mb-3 symbol-100px symbol-circle">
													<img alt="Pic" src="{{url('photos', $nomentreprise->photos)}}"/>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
												<a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bolder mb-1"> @if($nomentreprise)
												...
												<!--end::Name-->
												<!--begin::Position-->
												<div class="fs-6 fw-bold text-gray-400 mb-2"> @if($nomentreprise)
											...
											<div class="center-buttons">
												<a href="{{route('monentreprise.edit', $nomentreprise->id)}}" type="button" class="btn btn-violet" style="width: 220px;">Modifier les informations </a>
											    <a href="/createparticipant" type="button" class="btn btn-violet" disabled>Ajouter d'autres participants </a>
											</div>
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">Details de l'Entreprise</h3>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">Nom de l'Entreprise :</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">Slogan : </label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
													<span class="fw-bolder fs-6 text-dark">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">Numéro de Téléphone :
												</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 d-flex align-items-center">
													<span class="fw-bolder fs-6 me-2"> @if($nomentreprise)
												    {{$nomentreprise->tel_entreprise}}
												    @else
												    <p></p>
												    @endif</span>
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">Pays : 
											</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">Participants de mon Entreprise</h3>
											</div>
                               ...
                               <div class ="fg" style="display:flex;margin-left:-30px; margin-top: -35px;">
                                  <table><tr>
                               <td>
                               <a href="{{route('mesparticipant.edit', $participant->id)}}">
                                 <button type="button" class="btn btn-success "style="background:#008000;color:white; padding: 5px 8px;"><i class="bi bi-pen-fill" style="margin-left:5px;"></i></button>
                            </a>
                            </td>
                            <td>
                                <form action="{{route('mesparticipant.destroy', $participant->id)}}" method="post">
                                  {{ csrf_field() }}
                                  @method('DELETE')
                                <button type="submit" class="btn btn-danger "style="background:#C92C2B;color:white;padding: 5px 8px;"><i style="margin-left:5px;" class="bi bi-trash-fill"></i></button>  
                                </form> 
                                 </td>
                                 </tr></table>
                            </div>
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0"style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">Mes centres d'intérêts </h3>
											</div>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                                        <th>Secteurs d'activités recherchés : </th>
                                                        <th>Profils d'entreprises recherchés : </th>
                                                        <th>Type de partenaires recherchés : </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> 
												            <p>
												                @if($nomentreprise)
            												    {{$nomentreprise->partenaire_rencontrer_a}}
            												    @else
            												    <p></p>
            												    @endif</span>
            												    
                                                                <br> @if($nomentreprise)
            												    {{$nomentreprise->partenaire_rencontrer_b}}
            												    @else
            												    <p></p>
            												    @endif</span>
                                                                <br> @if($nomentreprise)
            												    {{$nomentreprise->partenaire_rencontrer_c}}
            												    @else
            												    <p></p>
            												    @endif</span>
                                                        ...
                                                        <td> 
												            <p>
												               @if($nomentreprise)
            												    {{$nomentreprise->profile_partenaire_rechercher_a}}
            												    @else
            												    <p></p>
            												    @endif</span>
                                                            @if($nomentreprise)
            												    {{$nomentreprise->profile_partenaire_rechercher_b}}
            												    @else
            												    <p></p>
            												    @endif</span>
                                                                @if($nomentreprise)
            												    {{$nomentreprise->profile_partenaire_rechercher_c}}
            												    @else
            												    <p></p>
            												    @endif</span>
                                                        ...
                                                        <td>
												            <p>
												              @if($nomentreprise)
            												    {{$nomentreprise->partenaire_rechercher}}
            												    @else
            												    <p></p>
            												    @endif</span>
												            </p>
                    ...
                    <li class="menu-item">
                    Partenaire : Salon International du Coton et du Textile
                    </li>
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="{{asset('User/assets/media/avatars/150-11.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{asset('User/assets/media/avatars/150-3.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{asset('User/assets/media/avatars/150-5.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="{{asset('User/assets/media/avatars/150-2.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="{{asset('User/assets/media/avatars/150-6.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{asset('User/assets/media/stock/300x270/1.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay me-10">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{asset('User/assets/media/stock/300x270/2.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{asset('User/assets/media/stock/300x270/3.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="{{asset('User/assets/media/avatars/150-14.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
