								...
								<div class="flex-column flex-lg-row-auto w-100 w-xl-325px mb-10">
									...
									<!--begin::Card header-->
										...
										<!--end::Card header-->
                                         ...
                                         <?php $sonentreprise = DB::table('entreprises')->where('id', $parti->entreprise_id)->first(); ?>
										<!--begin::Card body |-->
										<div class="card-body pt-0 p-10">
											...
											<div class="d-flex flex-center flex-column mb-10">
												...
												<div class="symbol mb-3 symbol-100px symbol-circle">
													<img alt="Pic" src="{{url('photos', $sonentreprise->photos)}}"/>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
												<a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bolder mb-1"> @if($sonentreprise)
												    {{$sonentreprise->nom_entreprise}}
												    @else
												    <p>No Entreprise</p>
												    @endif</a>
												<!--end::Name-->
												<!--begin::Position-->
												<div class="fs-6 fw-bold text-gray-400 mb-2"> @if($sonentreprise)
												    {{$sonentreprise->slogan}}
												    @else
												    <p></p>
												    @endif</div>
												<!--end::Position-->
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0">Details  l'Entreprise</h3>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<div class="card-body p-9">
											...
											<div class="row mb-7">
												...
												<div class="col-lg-8 d-flex align-items-center">
													<span class="fw-bolder fs-6 me-2"> @if($sonentreprise)
												    {{$sonentreprise->tel_entreprise}}
												    @else
												    <p></p>
												    @endif</span>
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0">Participants de mon Entreprise</h3>
											</div>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    <?php $participans = DB::table('participants')->where('entreprise_id', $parti->entreprise_id)->get(); ?>
                                                    @foreach($participans as $participante)
                                                    <tr>
                                                        <td> @if($participante)
												    {{$participante->nom}}
												    @else
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-header">
                                            <div class="card-title m-0">
												<h3 class="fw-bolder m-0">Mes centres d'intérêts </h3>
											</div>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    <?php $nomentreprise = DB::table('entreprises')->where('id', $parti->entreprise_id)->first(); ?>
                                                    <tr>
                                                        <td> 
												            <p>
												                @if($nomentreprise)
