 ...
 <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Mon profil</h3>
                    </div>
            ...
            <div class="container-fluid">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <form action="{{route('profil_user.update', $user->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
