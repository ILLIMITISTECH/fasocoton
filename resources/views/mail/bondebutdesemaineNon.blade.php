      ...
      <div style=" border: 1px solid #dadce0;   border-radius: 8px;   margin-bottom: 8px;">
       ...
       <img src="https://illimitis.collaboratis.com/v2/assets/images/logocollaboratis.png" alt="homepage" class="dark-logo" style="max-width: 80%;"><br><br>
        ...
        <div style=" padding: 24px 16px 32px;">
          ...
          <div style="font-size:16px;   font-family: &#39;Google Sans&#39;,Roboto,Arial,sans-serif;   line-height: 28px;   padding: 0 8px;color:black"> Nous vous invitons à prendre 2 min pour renseigner votre Focus de la semaine. 
          <p> Rappelez-vous: “il n’y a pas de vent favorable à celui qui ne sait où il va”</p>
          </div>
         <br><br><br>
