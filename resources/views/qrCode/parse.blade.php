									...
									<div class="card mb-5 mb-xl-6" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer" >
											...
											<div class="card-title m-0" >
												<h3 class="fw-bolder m-0"style="margin-left:30px;font-family:Lucida Console,Courier New,monospace;">{{$event ? $event->nom_event_fr : 'NONE' }} </h3>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
										...
										<div class="card-body p-9">
										    <div class="badge-container">
										        <div class="badge-header">
										            <h4 class="fw-bolder m-0">Informations:</h4>
										           
										        </div>
										    <!--begin::Row-->
											<div class="row mb-7">
												<!--begin::Label-->
												<div class="col-lg-4 fw-bold symbol mb-3 symbol-100px symbol-circle">
													<img src="{{url('image', $user->photo)}}" >
												</div>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<span class="fw-bolder fs-6 text-dark">&nbsp;&nbsp;{{$user->prenom}}&nbsp;{{$user->nom}} </span>
												</div>
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold ">Entreprise :</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold">Numéros de Téléphone :
												</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 d-flex align-items-center">
												    ...
												    @if($user)
												        <span class="fw-bolder fs-6 me-2">{{$user->portable}}</span>
												    @else
												        <p>None</p>
												    @endif</span>
											...
											<!--end::Input group-->
											<span class="alert alert-success col-lg-12 fw-bold" style="font-size:11px">Veuillez prendre soin de cette invité comme il se doit au sein de {{$event ? $event->nom_event_fr : 'NONE' }}</span>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row flex-stack">
							...
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								<li class="menu-item">
									Partenaire : Salon Internationnal du Coton
								</li>
