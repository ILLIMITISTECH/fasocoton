									...
									<div class="card mb-5 mb-xl-6" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer" >
											...
											<div class="card-title m-0" >
												...
												<a href="{{route('print.badge', Auth::id())}}" class="btn btn-violet" style="position :absolute; right :5%;"><span class="menu-title">Imprimer mon Badge</span></a>
										...
										<div class="card-body p-9">
											...
											<label class="col-lg-4 fw-bold">Mon code participant : 
												<div class="fs-6 fw-bold mb-8" style="margin-top:20px;">
												    ...
												    @endphp
												    <center>
												      {{ \QrCode::size(250)->generate('https://sicot2022.optievent.xyz/qrcode_parse/'.$data); }}
												    </center>
