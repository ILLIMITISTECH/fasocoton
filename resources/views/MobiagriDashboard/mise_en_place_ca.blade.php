        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
             <!-- <form action="{{route('search_mep')}}" method="get">
               <div class="row" style="display:flex;">
                <div class="mb-3 col-4" style="margin-top:7px;">
                  <label for="exampleFormControlSelect1" >Campagne :</label>
                  <select class="form-select form-control" name="search_mep" id="myselection" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_mepZ" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_mepS" id="exampleFormControlSelect1" aria-label="Default select example">
              ...
              <div class="row m-5 mb-5">
                <h4 class="text-primary">Mise en place</h4>
                <div class="card">
                    ...
                    <table class="table">
                      ...
                      <tbody class="table-border-bottom-0">
                        @foreach($mise_en_place as $mise_en_places)
                            <tr>
                              <td>{{$mise_en_places->prenom_producteur}} {{$mise_en_places->nom_producteur}}</td>
                              ...
                              <td>{{$mise_en_places->nbre_insecticides_type_1_specifiques_traitement}}</td>
                              <td>{{$mise_en_places->nbre_insecticides_type_2_specifiques_traitement}}</td>
                              <td>{{$mise_en_places->nbre_insecticides_type_3_specifiques_traitement}}</td>
                              <td>{{$mise_en_places->nbre_sac_engrais_npk_fu_50kg}}</td>
                              <td>{{$mise_en_places->nbre_sac_engrais_uree_50kg}}</td>
                              <td>{{$mise_en_places->total_engrais_mp}}</td>
                              <td>{{$mise_en_places->total_semence_mp}}</td>
                              <td>{{$mise_en_places->total_insecticide_mp}}</td>
                              <td>{{$mise_en_places->total_mp}}</td>
                            </tr>   
                        @endforeach
                      </tbody>
                    </table>
