          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
              <!--<form action="{{route('search_bc')}}" method="get">
               <div class="row" style="display:flex;">
                <div class="mb-3 col-4" style="margin-top:7px;">
                  ...
                  <select class="form-select form-control" name="search_bc" id="myselection" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_bcZ" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_bcS" id="exampleFormControlSelect1" aria-label="Default select example">
              ...
              <div class="row m-5 mb-5">
                <h4 class="text-primary">Besoin complementaire</h4>
                <div class="card">
                      ...
                      <tbody class="table-border-bottom-0">
                        @foreach($besoin_complementaire as $besoin_complementaires)
                            <tr>
                              ...
                              <td>{{$besoin_complementaires->total_engrais_bc}}</td>
                              <td>{{$besoin_complementaires->total_semence_bc}}</td>
                              <td>{{$besoin_complementaires->total_insecticide_bc}}</td>
                              <td>{{$besoin_complementaires->total_bc}}</td>
                            </tr>   
                        @endforeach
                      </tbody>
                    </table>
