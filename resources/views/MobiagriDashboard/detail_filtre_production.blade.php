                    ...
                    <div class="col-lg-12 mb-4 order-0">
                        <div class="card shadow-none bg-transparent border border-primary mb-3">
                            ...
                            @if (request()->input('campagne') !='')
                                @if($data <> '')
                                    <b>Campagne : {{request()->input('campagne')}}, {{request()->input('codeScoop').' - '.$data}}, Option : {{$title}}</b><hr>
                                @elseif($data == '')
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                ...
                                <div>
                                  ...
                                  <h2 class="card-title mb-2">{{number_format($qt1)}}</h2>
                                </div>
                              </div>
                               <div class="col-md-4">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                ...
                                <div>
                                  ...
                                  <h2 class="card-title mb-2">{{number_format($qt2)}}</h2>
                                </div>
                              </div>
                               <div class="col-md-4">
                                <div class="card-title d-flex align-items-start justify-content-between">
