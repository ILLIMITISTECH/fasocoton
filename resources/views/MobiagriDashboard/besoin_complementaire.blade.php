        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
              ...
              <div class="row pull-right" style="display:flex;" >
                    {{-- <form action="{{route('search_bc')}}" method="get">
                        <div class="row pull-right" style="display:flex;" >
                            <div class="mb-3 col-3">
                              <label for="exampleFormControlSelect1" class="form-label">Campagne Coton :</label>
                              <select class="form-select form-control" name="search_campagne_bc" id="campagne" aria-label="Default select example" required>
                            ...
                            <div class="mb-3 col-3">
                              ...
                              <select class="form-select form-control" name="search_zone_bc" id="exampleFormControlSelect1" aria-label="Default select example">
                                <option value="" selected>sélectionner la zone...</option>
                            ...
                            <div class="mb-3 col-4">
                              ...
                              <select class="form-select form-control" name="search_section_bc" id="exampleFormControlSelect1" aria-label="Default select example">
                                <option value="" selected>sélectionner la section...</option>
                                 @foreach ($sections as $item)
                                    <option value="{{$item->nom_section}}">{{$item->nom_section}}</option>
                                @endforeach
                              </select>
                            </div>
                  ...
                  <br>
                    ...
                    <table class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody class="table-border-bottom-0" id="clcTableBody">
                        @foreach($besoin_complementaire as $besoin_complementaires)
                            <tr>
                                
                              <td>{{$besoin_complementaires->nom_zone}}</td>
                              <td>{{$besoin_complementaires->nom_section}}</td>
                              <td>{{$besoin_complementaires->campagne_coton}}</td>
                              <td>{{$besoin_complementaires->prenom_producteur}} {{$besoin_complementaires->nom_producteur}}</td>
                              <td>{{$besoin_complementaires->code_scoop_producteur}}</td>
                              <td>{{$besoin_complementaires->nom_scoop}}</td>
                              <td>{{$besoin_complementaires->nbre_appareil_atomiseur_piece}}</td>
                              <td>{{$besoin_complementaires->nbre_appareil_dos_piece}}</td>
                              <td>{{$besoin_complementaires->nbre_appareil_pile_piece}}</td>
                              <td>{{$besoin_complementaires->nbre_epi_piece}}</td>
                              <td>{{$besoin_complementaires->nbre_herbicides_post_levee}}</td>
                              <td>{{$besoin_complementaires->nbre_herbicides_pre_levee}}</td>
                              <td>{{$besoin_complementaires->nbre_herbicides_total}}</td>
                              <td>{{$besoin_complementaires->nbre_insecticides_type_1_traitement}}</td>
                              <td>{{$besoin_complementaires->nbre_insecticides_type_2_traitement}}</td>
                              <td>{{$besoin_complementaires->nbre_insecticides_type_3_traitement}}</td>
                              <td>{{$besoin_complementaires->nbre_insecticides_type_1_specifiques_traitement}}</td>
                              <td>{{$besoin_complementaires->nbre_insecticides_type_2_specifiques_traitement}}</td>
                              <td>{{$besoin_complementaires->nbre_insecticides_type_3_specifiques_traitement}}</td>
                              <td>{{$besoin_complementaires->nbre_sac_engrais_npk_fu_50kg}}</td>
                              <td>{{$besoin_complementaires->nbre_sac_engrais_uree_50kg}}</td>
                              <td>{{$besoin_complementaires->total_engrais}}</td>
                              <td>{{$besoin_complementaires->total_semence}}</td>
                              <td>{{$besoin_complementaires->total_insecticide}}</td>
                              <td>{{$besoin_complementaires->total_montant_intrants}}</td>
                            </tr>   
                        @endforeach
                      </tbody>
                    </table>
