<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
           ...
           <!-- <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{route('prodGrpmt')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-group"></i>
                <div data-i18n="Basic">Producteurs et groupements</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('superficies')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-area"></i>
                <div data-i18n="Basic">Superficies</div>
              </a>
            </li>
            {{-- <li class="menu-item">
              <a href="{{route('evaluProducton')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-notepad"></i>
                <div data-i18n="Basic">Evaluation de la production</div>
              </a>
            </li> --}}
            <li class="menu-item">
              <a href="{{route('productionRealisee')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calculator"></i>
                <div data-i18n="Basic">Production réalisée</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('productionValorisee')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calculator"></i>
                <div data-i18n="Basic">Production valorisée </div>
              </a>
            </li>
            <!--<li class="menu-item">-->
            <!--  <a href="{{route('situationCredit')}}" class="menu-link">-->
            <!--    <i class="menu-icon tf-icons bx bx-calculator"></i>-->
           ...
           <!-- <li class="menu-item">
            ...
            {{-- @if (Auth::user()->nom_role == 'admin') --}}
              ...
              <li class="menu-item">
                <a href="{{route('suiviParasitisme')}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-money"></i>
