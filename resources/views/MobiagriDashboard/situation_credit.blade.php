        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
                ...
                <div class="mt-4"></div>
                <small class="text-primary text-muted">Situation du crédit</small>
                    <form action="{{route('filtreSituationCredit')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><br>
                                    ...
                                    <select class="form-select" name="option" id="option1" aria-label="Default select example" required>
                                        ...
                                        <option value="3">Impayés Antérieurs</option>
                                        <option value="4">Crédit Total</option>
                                    </select>
                                </div>
                            </div>
                            {{-- <div class="col-md-4">
