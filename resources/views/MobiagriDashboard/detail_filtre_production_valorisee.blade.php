                          ...
                          <div class="card-body">
                            ...
                            <div class="container">
                              <table id="example" class="table table-striped table-bordered" style="width:100%">
                               <label for="" @class(['text-muted', 'font-bold' => true])><b><u>Liste Producteurs : Production totale 1er choix</u></b></label><br><br>
                                <thead>
                                  <tr>
                                    <th>#</th>
                            ...
                            @if ($title == 'Prix du coton')
                              ...
                              <div class="col-md-6">
                                ...
                                <div>
                                  ...
                                  <h2 class="card-title mb-2">{{number_format($value1->prix_coton_1er_choix)}}</h2>
                                </div>
                              </div>
                               <div class="col-md-6">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                ...
                                <div>
                                  ...
                                  <h2 class="card-title mb-2">{{number_format($value2->prix_coton_2eme_choix)}}</h2>
                                </div>
                              </div>
                              </div>
                            </div>
