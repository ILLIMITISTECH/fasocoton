        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
                ...
                <div class="mt-4"></div>
                <small class="text-primary text-muted">Evaluation de la production</small>
                    <form action="{{route('filtreEvaluation_ca')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><br>
                                    ...
                                    <select class="form-select" name="option1" id="option1" aria-label="Default select example" required>
                                        <option selected disabled>Options</option>
                                        <option value="1">Interviews</option>
                                        <option value="2">Comptage </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
