                    ...
                    <table class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody class="table-border-bottom-0" id="clcTableBody">
                        @foreach($production as $productions)
                            <tr>
                              <td>{{ $productions->nom_zone }}</td>
                              <td>{{ $productions->nom_section }}</td>
                              <td>{{ $productions->campagne_coton }}</td>
                              <td>{{$productions->prenom_producteur}} {{$productions->nom_producteur}}</td>
                              <td>{{$productions->prix_coton_1er_choix}}</td>
                              <td>{{$productions->qte_1er_choix}}</td>
                              <td style="color:red;">{{(int)$productions->prix_coton_1er_choix * (int)$productions->qte_1er_choix}} </td>
                              <td>{{$productions->prix_coton_2eme_choix}}</td>
                              <td>{{$productions->qte_2eme_choix}}</td>
                              <td style="color:red;" >{{(int)$productions->prix_coton_2eme_choix * (int)$productions->qte_2eme_choix}}</td>
