        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
               <form action="{{route('search_dashboard_zone')}}" method="get">
               ...
               {{-- <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="searchS_zone" id="exampleFormControlSelect1" aria-label="Default select example" >
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <h5 class="text-primary">@if($segment) Campagne : {{$segment}} @endif</h5>
                ...
                <div class="col-lg-3 mb-4 order-0">
                  <div class="card shadow-none bg-transparent border border-primary mb-3">
                    <div class="card-body">
                      ...
                      <h3 class="card-title mb-2">{{number_format($producteursH)}}</h3>
                ...
                <div class="col-lg-3 mb-4 order-0">
                  <div class="card shadow-none bg-transparent border border-primary mb-3">
                    <div class="card-body">
                      ...
                      <h3 class="card-title mb-2">{{number_format($producteursF)}}</h3>
