        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
             <!--<form action="{{route('search_production')}}" method="get">
               <div class="row" style="display:flex;">
                <div class="mb-3 col-4" style="margin-top:7px;">
                  <label for="exampleFormControlSelect1" >Campagne :</label>
                  <select class="form-select form-control" name="search_production" id="myselection" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_productionZ" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_productionS" id="exampleFormControlSelect1" aria-label="Default select example">
              ...
              <div class="row m-5 mb-5">
                <h4 class="text-primary">Production</h4>
                <div class="card">
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th>Quantité 1er choix Mag</th>
                          <th>Quantité 2em choix</th>
                          <th>Quantité 2em choix Mag</th>
                      ...
                      <tbody class="table-border-bottom-0">
                        @foreach($production as $productions)
                            <tr>
                              <td>{{$productions->prenom_producteur}} {{$productions->nom_producteur}}</td>
                              <td>{{$productions->code_scoop_producteur}}</td>
                              <td>{{$productions->nom_scoop}}</td>
                              <td>{{$productions->type_marche}}</td>
                              <td>{{$productions->qte_1er_choix}}</td>
                              <td>{{$productions->qte_1er_choix_mag}}</td>
                              <td>{{$productions->qte_2eme_choix}}</td>
                              <td>{{$productions->qte_2eme_choix_mag}}</td>
                              <td>{{$productions->total_prix_coton_1er_choix}}</td>
                              <td>{{$productions->total_prix_coton_2eme_choix}}</td>
                              
                              
                              <td>{{$productions->campagne_coton}}</td>
                              <td>{{$productions->nbre_appareil_atomiseur_piece}}</td>
                              <td>{{$productions->nbre_appareil_dos_piece}}</td>
                              <td>{{$productions->nbre_appareil_pile_piece}}</td>
                              <td>{{$productions->nbre_epi_piece}}</td>
                              <td>{{$productions->nbre_herbicides_post_levee}}</td>
                              <td>{{$productions->nbre_herbicides_pre_levee}}</td>
                              <td>{{$productions->nbre_herbicides_total}}</td>
                              <td>{{$productions->nbre_insecticides_type_1_traitement}}</td>
                              <td>{{$productions->nbre_insecticides_type_2_traitement}}</td>
                              <td>{{$productions->nbre_insecticides_type_3_traitement}}</td>
                              <td>{{$productions->nbre_insecticides_type_1_specifiques_traitement}}</td>
                              <td>{{$productions->nbre_insecticides_type_2_specifiques_traitement}}</td>
                              <td>{{$productions->nbre_insecticides_type_3_specifiques_traitement}}</td>
                              <td>{{$productions->nbre_sac_engrais_npk_fu_50kg}}</td>
                              <td>{{$productions->nbre_sac_engrais_uree_50kg}}</td>
