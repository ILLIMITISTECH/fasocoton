        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
             <div class="container flex-grow-1 container-p-y">
              <form action="{{route('search_dashboard_ca')}}" method="get">
               <div class="row" style="display:flex;">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="searchS_ca" id="exampleFormControlSelect1" aria-label="Default select example" >
                    @php $scoop_groups = DB::table('scoops')->where('closed', 'false')->where('section', Auth::user()->nom_role)->get(); @endphp
