        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
                ...
                {{-- <div class="row pull-right" style="display:flex;" >
                    <form action="{{route('search_cdc')}}" method="get">
                        <div class="row pull-right" style="display:flex;" >
                            
                            <div class="mb-3 col-3">
                              <label for="exampleFormControlSelect1" class="form-label">Campagne Coton :</label>
                              <select class="form-select form-control" name="search_campagne_cdc" id="campagne" aria-label="Default select example" required>
                            ...
                            <div class="mb-3 col-3">
                              ...
                              <select class="form-select form-control" name="search_zone_cdc" id="exampleFormControlSelect1" aria-label="Default select example">
                            ...
                            <div class="mb-3 col-4">
                              ...
                              <select class="form-select form-control" name="search_section_cdc" id="exampleFormControlSelect1" aria-label="Default select example">
                      ...
                      <tbody class="table-border-bottom-0"  id="clcTableBody">
                        @foreach($cdc as $cdcs)
                            <tr>
                              {{-- @dd($cdc) --}}
                              <td>{{$cdcs->nom_zone}}</td>
                              <td>{{$cdcs->nom_section}}</td>
                              <td>{{$cdcs->campagne_coton}}</td>
                              <td>{{$cdcs->code_scoop_producteur}}</td>
                              <td>{{$cdcs->nom_scoop}}</td>
                              <td>{{$cdcs->nbre_appareil_atomiseur_piece}}</td>
                              <td>{{$cdcs->nbre_appareil_dos_piece}}</td>
                              <td>{{$cdcs->nbre_appareil_pile_piece}}</td>
                              <td>{{$cdcs->nbre_epi_piece}}</td>
                              <td>{{$cdcs->nbre_herbicides_post_levee}}</td>
                              <td>{{$cdcs->nbre_herbicides_pre_levee}}</td>
                              <td>{{$cdcs->nbre_herbicides_total}}</td>
                              <td>{{$cdcs->nbre_insecticides_type_1_traitement}}</td>
                              <td>{{$cdcs->nbre_insecticides_type_2_traitement}}</td>
                              <td>{{$cdcs->nbre_insecticides_type_3_traitement}}</td>
                              <td>{{$cdcs->nbre_insecticides_type_1_specifiques_traitement}}</td>
                              <td>{{$cdcs->nbre_insecticides_type_2_specifiques_traitement}}</td>
                              <td>{{$cdcs->nbre_insecticides_type_3_specifiques_traitement}}</td>
                              <td>{{$cdcs->nbre_sac_engrais_npk_fu_50kg}}</td>
                              <td>{{$cdcs->nbre_sac_engrais_uree_50kg}}</td>
                              <td>{{$cdcs->total_engrais_cdc}}</td>
                              <td>{{$cdcs->total_semence_cdc}}</td>
                              <td>{{$cdcs->total_insecticide_cdc}}</td>
                              <td>{{$cdcs->total_cdc}}</td>
                            </tr>   
                        @endforeach
                      </tbody>
                    </table>
