      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <!-- <form action="{{route('search_producteur')}}" method="get">
               <div class="row" style="display:flex;">
                <div class="mb-3 col-4" style="margin-top:7px;">
                  <label for="exampleFormControlSelect1" >Campagne :</label>
                  <select class="form-select form-control" name="search_producteur" id="myselection" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_producteurZ" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="mb-3 col-3">
                  ...
                  <select class="form-select form-control" name="search_producteurS" id="exampleFormControlSelect1" aria-label="Default select example">
                 ...
                 $producteurs_nbre = DB::table('producteurs')->select('scoops.code_scoop', 'producteurs.prenom_producteur','producteurs.nom_producteur', 'producteurs.actif',
                    'producteurs.code_producteur','producteurs.code_scoop_producteur','producteurs.date_de_naissance',
                    'scoops.nom_scoop', 'producteurs.closed', 'scoops.village', 'scoops.closed')
              ...
              <div class="row m-5 mb-5">
                <h4 class="text-primary">Liste des producteurs, nombre : {{count($producteurs_nbre)}}</h4>
                <div class="card">
                    ...
                    <table class="table">
                      ...
                      <tbody class="table-border-bottom-0">
                        @foreach($producteurs as $producteur)
                            <tr>
                              <td>{{$producteur->nom_producteur}} {{$producteur->prenom_producteur}} </td>
                              <td>{{$producteur->code_producteur ? $producteur->code_producteur : '--'}}</td>
                              <td>{{$producteur->code_scoop_producteur ? $producteur->code_scoop_producteur : '--'}}</td>
                              <td>{{$producteur->nom_scoop ? $producteur->nom_scoop : '--'}}</td>
                              <td>{{$producteur->village ? $producteur->village : '--'}}</td>
                              <td>{{$producteur->date_de_naissance ? $producteur->date_de_naissance : '--'}}</td>
                            </tr>   
                        @endforeach
                      </tbody>
                    </table>
                    {{ $producteurs->render("pagination::bootstrap-4") }}
                  </div>
                </div>
              </div>
