        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container flex-grow-1 container-p-y">
                ...
                <div class="mt-4"></div>
                <small class="text-primary text-muted">Superficies</small>
                    <form action="{{route('filtreSuperficie')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4" >
                                <div class="form-group"><br>
                                    ...
                                    <select class="form-select" name="campagne" aria-label="Default select example" required>
                                        <option value="" selected disabled>Sélectionner la campagne</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><br>
                                    ...
                                    <select class="form-select" name="option" aria-label="Default select example" required>
                                        ...
                                        <option value="1">Superficies prévues</option>
                                        <option value="2">Superficies déclarées</option>
                                        <option value="3">Superficies mesurées</option>
                                        <option value="5">Superficies perdues</option>
                                        <option value="6">Superficies corrigées</option>
                                        <option value="7">Superficies réalisées</option>
                                        <option value="8">Superficies productives</option>
                                    </select>
                                </div>
                            </div> 
